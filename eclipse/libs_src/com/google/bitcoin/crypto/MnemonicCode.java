 ...
 * lists of words per <a
 * href="https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki">the BIP
 * 39 specification</a>
 */
...
public class MnemonicCode {
	...
	public MnemonicCode() throws IOException {
		this(MnemonicCode.class
				.getResourceAsStream("mnemonic/wordlist/english.txt"),
				BIP39_ENGLISH_SHA256);
	}

	/**
	 * Creates an MnemonicCode object, initializing with words read from the
	 * supplied input stream. If a wordListDigest is supplied the digest of the
	 * words will be checked.
	 */
	public MnemonicCode(InputStream wordstream, String wordListDigest)
		...
		if (this.wordList.size() != 2048)
			throw new IllegalArgumentException(
					"input stream did not contain 2048 words");
	...
	public List<String> toMnemonic(byte[] entropy)
		...
		boolean[] concatBits = new boolean[entropyBits.length
				+ checksumLengthBits];
		System.arraycopy(entropyBits, 0, concatBits, 0, entropyBits.length);
		System.arraycopy(hashBits, 0, concatBits, entropyBits.length,
				checksumLengthBits);
