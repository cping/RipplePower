 ...
 * an AES key that is derived from a user entered password. You need the
...
public class EncryptedPrivateKey {
	...
	@Override
	public int hashCode() {
		return com.google.common.base.Objects.hashCode(encryptedPrivateBytes,
	...
	public String toString() {
		return "EncryptedPrivateKey [initialisationVector="
				+ Arrays.toString(initialisationVector)
				+ ", encryptedPrivateKey="
				+ Arrays.toString(encryptedPrivateBytes) + "]";
	}
