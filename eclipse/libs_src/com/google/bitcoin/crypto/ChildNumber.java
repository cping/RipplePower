 ...
 * getter for the first bit and a getter for the actual 0-based child number. A
 * {@link List} of these forms a <i>path</i> through a
...
public class ChildNumber {
	...
	/**
	 * Integer i as per BIP 32 spec, including the MSB denoting derivation type
	 * (0 = public, 1 = private)
	 **/
	private final int i;
	...
	public String toString() {
		return String.format("%d%s", getChildNumber(),
				isPrivateDerivation() ? "'" : "");
	}
