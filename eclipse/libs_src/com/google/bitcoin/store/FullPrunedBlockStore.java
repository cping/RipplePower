 ...
 * 
 * <p>
 * In addition to keeping tack of a chain using {@link StoredBlock}s, it should
 ...
 * 
 * <p>
 * A FullPrunedBlockStore also contains a map of hash+index to
 * StoredTransactionOutput. Again, the hash is a standard Bitcoin double-SHA256
...
public interface FullPrunedBlockStore extends BlockStore {
	...
	/**
	 * Gets a {@link StoredTransactionOutput} with the given hash and index, or
	...
	/**
	 * Adds a {@link StoredTransactionOutput} to the list of unspent
	 * TransactionOutputs
	 */
	...
	/**
	 * Removes a {@link StoredTransactionOutput} from the list of unspent
