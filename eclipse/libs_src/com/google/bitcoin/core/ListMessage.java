...
/**
 * Abstract superclass of classes with list based payload, ie InventoryMessage
 * and GetDataMessage.
 */
public abstract class ListMessage extends Message {
	...
	public ListMessage(NetworkParameters params, byte[] msg, boolean parseLazy,
	...
	protected void parseLite() throws ProtocolException {
		...
		if (arrayLen > MAX_INVENTORY_ITEMS)
			throw new ProtocolException("Too many items in INV message: "
					+ arrayLen);
	...
	public void parse() throws ProtocolException {
		// An inv is vector<CInv> where CInv is int+hash. The int is either 1 or
		// 2 for tx or block.
