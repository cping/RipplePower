...
/**
 * Represents the "getblocks" P2P network message, which requests the hashes of
 * the parts of the block chain we're missing. Those blocks can then be
 * downloaded with a {@link GetDataMessage}.
 */
public class GetBlocksMessage extends Message {
	...
	public GetBlocksMessage(NetworkParameters params, List<Sha256Hash> locator,
			Sha256Hash stopHash) {
		super(params);
	...
	public GetBlocksMessage(NetworkParameters params, byte[] msg)
	...
	protected void parseLite() throws ProtocolException {
		...
		if (startCount > 500)
			throw new ProtocolException(
					"Number of locators cannot be > 500, received: "
							+ startCount);
	...
	protected void bitcoinSerializeToStream(OutputStream stream)
		...
		// Then a vector of block hashes. This is actually a "block locator", a
		// set of block
		// identifiers that spans the entire chain with exponentially increasing
		// gaps between
