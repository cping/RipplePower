...
public abstract class NetworkParameters implements Serializable {
	...
	private static Block createGenesis(NetworkParameters n) {
		...
		try {
			...
			t.addOutput(new TransactionOutput(n, t, Utils.toNanoCoins(50, 0),
	 ...
	 */
	public static final BigInteger MAX_MONEY = new BigInteger("21000000", 10)
			.multiply(COIN);
	 ...
	 * {@link com.google.bitcoin.core.Address}. This is the same as
	 ...
	 * {@link com.google.bitcoin.core.DumpedPrivateKey}.
	 */
	...
	/**
	 * The key used to sign {@link com.google.bitcoin.core.AlertMessage}s. You
	 * can use
	 * {@link com.google.bitcoin.core.ECKey#verify(byte[], byte[], byte[])} to
