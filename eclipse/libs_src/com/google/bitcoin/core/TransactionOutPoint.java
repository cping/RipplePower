...
public class TransactionOutPoint extends ChildMessage implements Serializable {
	...
	// This is not part of Bitcoin serialization. It's included in Java
	// serialization.
	// It points to the connected transaction.
	Transaction fromTx;

	public TransactionOutPoint(NetworkParameters params, long index,
	 ...
	 * message.
	 */
	public TransactionOutPoint(NetworkParameters params, byte[] payload,
	 ...
	 * pay-to-address scripts or pay-to-key scripts. If the script forms cannot
	 * be understood, throws ScriptException.
	 * 
