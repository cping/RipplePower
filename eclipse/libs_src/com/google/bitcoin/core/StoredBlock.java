...
public class StoredBlock implements Serializable {
	...
	// chain. As of May 2011 it takes 8
	...
	public static final int COMPACT_SERIALIZED_SIZE = Block.HEADER_SIZE
			+ CHAIN_WORK_BYTES + 4; // for height
	...
	public boolean equals(Object other) {
		...
		return o.header.equals(header) && o.chainWork.equals(chainWork)
				&& o.height == height;
	}
	...
	public StoredBlock build(Block block) throws VerificationException {
		// Stored blocks track total work done in this chain, because the
		// canonical chain is the one that represents
	 ...
	 * {@link CheckpointManager}.
	 */
	public static StoredBlock deserializeCompact(NetworkParameters params,
	...
	public String toString() {
		return String.format("Block %s at height %d: %s", getHeader()
