...
/**
 * Contains minimal data neccessary to disconnect/connect the transactions in
 * the stored block at will. Can either store the full set of transactions (if
 * the inputs for the block have not been tested to work) or the set of
 * transaction outputs created/destroyed when the block is connected.
 */
public class StoredUndoableBlock implements Serializable {
	...
	/**
	 * Get the transaction output changes if they have been calculated,
	 * otherwise null. Only one of this and getTransactions() will return a
	 * non-null value.
	 */
	...
	/**
	 * Get the full list of transactions if it is stored, otherwise null. Only
	 * one of this and getTxOutChanges() will return a non-null value.
	 */
