...
/**
 * An element that is either an opcode or a raw byte array (signature, pubkey,
 * etc).
 */
public class ScriptChunk {
	...
	public boolean equals(Object o) {
		...
		if (isOpCode != chunk.isOpCode)
			return false;
		if (startLocationInProgram != chunk.startLocationInProgram)
			return false;
		if (!Arrays.equals(data, chunk.data))
			return false;
