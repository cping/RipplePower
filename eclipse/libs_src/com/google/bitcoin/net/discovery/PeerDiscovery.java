...
/**
 * A PeerDiscovery object is responsible for finding addresses of other nodes in
 * the Bitcoin P2P network. Note that the addresses returned may or may not be
