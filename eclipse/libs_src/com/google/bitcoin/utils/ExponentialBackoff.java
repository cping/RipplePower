 ...
 * 
 * <p>
 * The retries are exponentially backed off, up to a maximum interval. On
 * success the back off interval is reset.
 * </p>
 */
public class ExponentialBackoff implements Comparable<ExponentialBackoff> {
	...
	public static class Params {
		...
		public Params(long initialMillis, float multiplier, long maximumMillis) {
			...
			checkArgument(maximumMillis >= initialMillis,
					"maximum must not be less than initial");
