...
public class ServerInfo {
	...
	public Amount computeFee(int units) {
		if (!updated) {
			throw new IllegalStateException(
					"No information from the server yet");
		}
	...
	public void update(JSONObject json) {
		// TODO, this might asking for trouble, just assuming certain fields, it
		// should BLOW UP
		...
		validated_ledgers = json.optString("validated_ledgers",
				validated_ledgers);
