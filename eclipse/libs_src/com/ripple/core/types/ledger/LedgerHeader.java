...
public class LedgerHeader {
	...
	public Hash256 previousLedger; // The hash of the previous ledger (0 for
									// genesis ledger)
	public Hash256 transactionHash; // The hash of the transaction tree's root
									// node.
	...
	public UInt32 closeTime; // UTC minute ledger closed encoded as seconds
								// since 1/1/2000 (or 0 for genesis ledger)
	public UInt8 closeResolution; // The resolution (in seconds) of the close
									// time
	...
	public static LedgerHeader fromReader(STReader reader) {
		...
		ledger.closeDate = RippleDate
				.fromSecondsSinceRippleEpoch(ledger.closeTime);
