...
public class Ledger {
	...
	UInt64 totalXRP; //
	Hash256 previousLedger; // The hash of the previous ledger (0 for genesis
							// ledger)
	...
	UInt32 closeTime; // UTC minute ledger closed encoded as seconds since
						// 1/1/2000 (or 0 for genesis ledger)
