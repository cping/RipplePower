...
public class Index {
	...
	public static Hash256 rippleState(AccountID a1, AccountID a2,
			Currency currency) {
	...
	public static Hash256 rippleState(List<AccountID> accounts,
			Currency currency) {
	...
	public static Hash256 ownerDirectory(AccountID account) {
		return Hash256
				.prefixedHalfSha512(LedgerSpace.ownerDir, account.bytes());
	}
	...
	public static Hash256 ledgerHashes(long prev) {
		return prefixed256(LedgerSpace.skipList).add(new UInt32(prev >> 16))
				.finish();
	}
