...
public enum EngineResult implements SerializedType {
	...
	temMALFORMED(-299, "Malformed transaction."), temBAD_AMOUNT(-298,
	...
	temUNCERTAIN(-272, "In process of determining result. Never returned."), temUNKNOWN(
			-271, "The transactions requires logic not implemented yet."),

	tefFAILURE(-199, "Failed to apply."), tefALREADY(-198,
	...
	terRETRY(-99, "Retry transaction."), terFUNDS_SPENT(-98,
			...
			"Process last."), terNO_RIPPLE(-90, "Process last."),

	tesSUCCESS(0, "The transaction was applied."), tecCLAIM(100,
