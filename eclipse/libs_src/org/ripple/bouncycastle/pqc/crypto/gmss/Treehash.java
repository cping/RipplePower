...
public class Treehash {
	...
	public void initializeSeed(byte[] seedIn) {
		System.arraycopy(seedIn, 0, this.seedNext, 0,
	...
	public void initialize() {
		...
		this.isInitialized = true;
		System.arraycopy(this.seedNext, 0, this.seedActive, 0,
				messDigestTree.getDigestSize());
	}
	...
	public void update(GMSSRandom gmssRandom, byte[] leaf) {
		...
		if (this.firstNode == null) {
			...
			while (this.tailLength > 0
				...
				System.arraycopy(help, 0, toBeHashed,
						this.messDigestTree.getDigestSize(),
						this.messDigestTree.getDigestSize());
	...
	public int getLowestNodeHeight() {
		if (this.firstNode == null) {
			...
			return Math.min(this.firstNodeHeight,
