...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
	...
	public void init(boolean forSigning, CipherParameters param) {
		...
		if (forSigning) {
			if (param instanceof ParametersWithRandom) {
				...
				this.key = (McElieceCCA2PublicKeyParameters) rParam
						.getParameters();
	...
	public byte[] messageEncrypt(byte[] input) throws Exception {
		...
		byte[] encC4 = McElieceCCA2Primitives.encryptionPrimitive(
				(McElieceCCA2PublicKeyParameters) key, c4Vec, z).getEncoded();
	...
	public byte[] messageDecrypt(byte[] input) throws Exception {
		...
		GF2Vector[] c4z = McElieceCCA2Primitives.decryptionPrimitive(
				(McElieceCCA2PrivateKeyParameters) key, encC4Vec);
