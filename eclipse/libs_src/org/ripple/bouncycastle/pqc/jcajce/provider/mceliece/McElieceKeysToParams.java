...
public class McElieceKeysToParams {
	...
	static public AsymmetricKeyParameter generatePublicKeyParameter(
		...
		if (key instanceof BCMcEliecePublicKey) {
			...
			return new McEliecePublicKeyParameters(k.getOIDString(), k.getN(),
					k.getT(), k.getG(), k.getMcElieceParameters());
		}

		throw new InvalidKeyException("can't identify McEliece public key: "
	...
	static public AsymmetricKeyParameter generatePrivateKeyParameter(
		...
		if (key instanceof BCMcEliecePrivateKey) {
			...
			return new McEliecePrivateKeyParameters(k.getOIDString(), k.getN(),
					k.getK(), k.getField(), k.getGoppaPoly(), k.getSInv(),
					k.getP1(), k.getP2(), k.getH(), k.getQInv(),
					k.getMcElieceParameters());
		}
