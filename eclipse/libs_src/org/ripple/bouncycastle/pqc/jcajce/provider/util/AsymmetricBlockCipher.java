...
public abstract class AsymmetricBlockCipher extends CipherSpiExt {
	 ...
	 * the input length <tt>inLen</tt> (in bytes). This call takes into account
	 * any unprocessed (buffered) data from a previous update call, and padding.
	 ...
	 *             cipher, or if this cipher is being initialized for decryption
	 ...
	 *             cipher.
	 * @throws InvalidAlgorithmParameterException
	 *             if the given parameters are inappropriate for initializing
	 *             this cipher.
	 */
	 ...
	 * 
	 * @param input
	 *            the ciphertext to be decrypted (the ciphertext length is less
	 *            than or equal to maxCipherTextSize)
