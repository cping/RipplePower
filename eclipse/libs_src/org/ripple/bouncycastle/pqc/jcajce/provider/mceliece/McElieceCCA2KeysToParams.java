...
public class McElieceCCA2KeysToParams {
	...
	static public AsymmetricKeyParameter generatePublicKeyParameter(
		...
		if (key instanceof BCMcElieceCCA2PublicKey) {
			...
			return new McElieceCCA2PublicKeyParameters(k.getOIDString(),
					k.getN(), k.getT(), k.getG(), k.getMcElieceCCA2Parameters());
		}

		throw new InvalidKeyException(
				"can't identify McElieceCCA2 public key: "
	...
	static public AsymmetricKeyParameter generatePrivateKeyParameter(
		...
		if (key instanceof BCMcElieceCCA2PrivateKey) {
			...
			return new McElieceCCA2PrivateKeyParameters(k.getOIDString(),
					k.getN(), k.getK(), k.getField(), k.getGoppaPoly(),
					k.getP(), k.getH(), k.getQInv(),
					k.getMcElieceCCA2Parameters());
		}

		throw new InvalidKeyException(
				"can't identify McElieceCCA2 private key.");
	}
}
