...
public abstract class CipherSpiExt extends CipherSpi {
	 ...
	 *             and requires algorithm parameters and the parameters are
	 *             null.
	 */
	 ...
	 *             if neither the mode with the given name nor the default mode
	 *             can be found
	 */
	 ...
	 *             if this cipher is a block cipher and the total input length
