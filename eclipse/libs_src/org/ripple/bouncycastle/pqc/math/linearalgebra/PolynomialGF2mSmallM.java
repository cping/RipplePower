...
public class PolynomialGF2mSmallM {
	 ...
	 * <tt>poly(X) -> [coef_0, coef_1, ...]</tt> is used, where <tt>coef_i</tt>
	 * is the <tt>i</tt>th coefficient of the polynomial represented as int (see
	 ...
	 *             if <tt>element</tt> is not an element of the finite field
	 *             this polynomial is defined over.
	 */
	 ...
	 *            the polynomial ring defining the square root matrix
