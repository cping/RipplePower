 ...
 * rings. If you want to read an entire secret key file in one hit this is the
 * class for you.
 */
public class PGPSecretKeyRingCollection {
	...
	public PGPSecretKeyRingCollection(byte[] encoding) throws IOException,
			PGPException {
	 ...
	 * @throws IOException
	 *             if a problem parsinh the base stream occurs
	 * @throws PGPException
	 *             if an object is encountered which isn't a PGPSecretKeyRing
	 */
	public PGPSecretKeyRingCollection(InputStream in) throws IOException,
			PGPException {
	 ...
	 *            the user ID to be matched.
	 * @param matchPartial
	 *            if true userID need only be a substring of an actual ID string
	 *            to match.
	 * @return an iterator (possibly empty) of key rings which matched.
	 * @throws PGPException
	 */
	 ...
	 */
	public Iterator getKeyRings(String userID, boolean matchPartial,
			boolean ignoreCase) throws PGPException {
	...
	/**
	 * Return true if a key matching the passed in key ID is present, false
	 * otherwise.
	 * 
	 * @param keyID
	 *            key ID to look for.
	...
	/**
	 * Return a new collection object containing the contents of the passed in
	 * collection and the passed in secret key ring.
	 * 
	 * @param ringCollection
	 *            the collection the ring to be added to.
	 * @param secretKeyRing
	...
	/**
	 * Return a new collection object containing the contents of this collection
	 * with the passed in secret key ring removed.
	 * 
	 * @param ringCollection
