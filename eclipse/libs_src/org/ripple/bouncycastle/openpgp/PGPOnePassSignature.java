...
public class PGPOnePassSignature {
	 ...
	 * Initialise the signature object for verification.
	 * 
	 * @param verifierBuilderProvider
	 *            provider for a content verifier builder for the signature type
	 *            of interest.
	 * @param pubKey
	...
	public void init(PGPContentVerifierBuilderProvider verifierBuilderProvider,
		...
		PGPContentVerifierBuilder verifierBuilder = verifierBuilderProvider
				.get(sigPack.getKeyAlgorithm(), sigPack.getHashAlgorithm());
	...
	public boolean verify(PGPSignature pgpSig) throws PGPException,
		...
		try {
			...
			throw new PGPException("unable to add trailer: " + e.getMessage(),
					e);
		}
