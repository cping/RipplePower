...
public class PBEFileProcessor {
	...
	private static void encryptFile(String outputFileName,
			String inputFileName, char[] passPhrase, boolean armor,
	...
	private static void encryptFile(OutputStream out, String fileName,
		...
		try {
			byte[] compressedData = PGPExampleUtil.compressFile(fileName,
	...
	public static void main(String[] args) throws Exception {
		...
		if (args[0].equals("-e")) {
			if (args[1].equals("-a") || args[1].equals("-ai")
					|| args[1].equals("-ia")) {
				encryptFile(args[2] + ".asc", args[2], args[3].toCharArray(),
						true, (args[1].indexOf('i') > 0));
			} else if (args[1].equals("-i")) {
				encryptFile(args[2] + ".bpg", args[2], args[3].toCharArray(),
						false, true);
			} else {
				encryptFile(args[1] + ".bpg", args[1], args[2].toCharArray(),
						false, false);
			}
			...
			System.err
					.println("usage: PBEFileProcessor -e [-ai]|-d file passPhrase");
		}
	}
}
