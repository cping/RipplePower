...
public class DetachedSignatureProcessor {
	private static void verifySignature(String fileName, String inputFileName,
			String keyFileName) throws GeneralSecurityException, IOException,
			PGPException {
	 ...
	 */
	private static void verifySignature(String fileName, InputStream in,
			InputStream keyIn) throws GeneralSecurityException, IOException,
			PGPException {
	...
	private static void createSignature(String inputFileName,
			String keyFileName, String outputFileName, char[] pass,
			boolean armor) throws GeneralSecurityException, IOException,
			PGPException {
		InputStream keyIn = new BufferedInputStream(new FileInputStream(
				keyFileName));
	...
	private static void createSignature(String fileName, InputStream keyIn,
	...
	public static void main(String[] args) throws Exception {
		...
		if (args[0].equals("-s")) {
			if (args[1].equals("-a")) {
				createSignature(args[2], args[3], args[2] + ".asc",
						args[4].toCharArray(), true);
			} else {
				createSignature(args[1], args[2], args[1] + ".bpg",
						args[3].toCharArray(), false);
			}
