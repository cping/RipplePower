...
class PGPExampleUtil {
	static byte[] compressFile(String fileName, int algorithm)
			throws IOException {
	 ...
	 */
	static PGPPrivateKey findSecretKey(PGPSecretKeyRingCollection pgpSec,
	...
	static PGPPublicKey readPublicKey(String fileName) throws IOException,
			PGPException {
	 ...
	 * @throws PGPException
	 */
	static PGPPublicKey readPublicKey(InputStream input) throws IOException,
			PGPException {
