...
public class PGPV3SignatureGenerator {
	 ...
	 */
	public PGPV3SignatureGenerator(int keyAlgorithm, int hashAlgorithm,
	...
	public PGPV3SignatureGenerator(int keyAlgorithm, int hashAlgorithm,
		...
		this.contentSignerBuilder = new JcaPGPContentSignerBuilder(
				keyAlgorithm, hashAlgorithm).setProvider(provider);
	}
	...
	public PGPSignature generate() throws PGPException, SignatureException {
		...
		return new PGPSignature(new SignaturePacket(3, contentSigner.getType(),
				contentSigner.getKeyID(), contentSigner.getKeyAlgorithm(),
				contentSigner.getHashAlgorithm(), creationTime * 1000,
				fingerPrint, sigValues));
	}
}
