...
public class PGPPBEEncryptedData extends PGPEncryptedData {
	...
	PGPPBEEncryptedData(SymmetricKeyEncSessionPacket keyData,
	...
	public InputStream getDataStream(char[] passPhrase, Provider provider)
			throws PGPException {
		return getDataStream(new JcePBEDataDecryptorFactoryBuilder(
	...
	public int getSymmetricAlgorithm(
			PBEDataDecryptorFactory dataDecryptorFactory) throws PGPException {
		byte[] key = dataDecryptorFactory.makeKeyFromPassPhrase(
				keyData.getEncAlgorithm(), keyData.getS2K());
