...
public class PGPCompressedDataGenerator implements CompressionAlgorithmTags,
		...
		if (compression != Deflater.DEFAULT_COMPRESSION) {
			if ((compression < Deflater.NO_COMPRESSION)
				...
				throw new IllegalArgumentException(
						"unknown compression level: " + compression);
			}
		}
	...
	/**
	 * Return an OutputStream which will save the data being written to the
	 * compressed object.
	 * <p>
	...
	/**
	 * Return an OutputStream which will compress the data as it is written to
	 ...
	 * </p>
	 * <p>
	 * <b>Note</b>: using this may break compatibility with RFC 1991 compliant
	 * tools. Only recent OpenPGP implementations are capable of accepting these
	 * streams.
	 * </p>
	 * 
	 * @param out
	...
	/**
	 * Close the compressed object - this is equivalent to calling close on the
	 * stream returned by the open() method.
	 * 
	 * @throws IOException
	 */
	...
	private class SafeDeflaterOutputStream extends DeflaterOutputStream {
		public SafeDeflaterOutputStream(OutputStream output, int compression,
				boolean nowrap) {
