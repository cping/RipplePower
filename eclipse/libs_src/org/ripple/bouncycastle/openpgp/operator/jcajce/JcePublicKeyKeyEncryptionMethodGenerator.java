...
public class JcePublicKeyKeyEncryptionMethodGenerator extends
	...
	public JcePublicKeyKeyEncryptionMethodGenerator setProvider(
			Provider provider) {
	 ...
	 */
	public JcePublicKeyKeyEncryptionMethodGenerator setSecureRandom(
			SecureRandom random) {
		this.random = random;
