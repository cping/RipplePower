 ...
 * a hash that includes the time of creation, if you pass a different date to
 * the constructor below with the same public private key pair the KeyID will
 * not be the same as for previous generations of the key, so ideally you only
...
public class PGPKeyPair {
	 ...
	 * @deprecated use BcPGPKeyPair or JcaPGPKeyPair as appropriate.
	 */
	public PGPKeyPair(int algorithm, PublicKey pubKey, PrivateKey privKey,
			Date time, String provider) throws PGPException,
	...
	public PGPKeyPair(int algorithm, PublicKey pubKey, PrivateKey privKey,
		...
		this.priv = new PGPPrivateKey(pub.getKeyID(), pub.getPublicKeyPacket(),
				privPk);
	}
