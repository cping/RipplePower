...
public class PGPPublicKeyRingCollection {
	...
	public PGPPublicKeyRingCollection(byte[] encoding) throws IOException,
			PGPException {
	 ...
	 * collection and the passed in public key ring.
	 * 
	 ...
	 * with the passed in public key ring removed.
	 * 
	 * @param ringCollection
