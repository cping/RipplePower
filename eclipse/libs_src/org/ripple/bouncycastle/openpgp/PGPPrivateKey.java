...
public class PGPPrivateKey {
	...
	/**
	 * Create a PGPPrivateKey from a regular private key and the keyID of its
	...
	public PGPPrivateKey(PrivateKey privateKey, long keyID) {
		...
		if (privateKey instanceof RSAPrivateCrtKey) {
			...
			privateKeyDataPacket = new RSASecretBCPGKey(
					rsK.getPrivateExponent(), rsK.getPrimeP(), rsK.getPrimeQ());
	 ...
	 * Base constructor.
	 * 
	 * Create a PGPPrivateKey from a keyID and the associated public/private
	 * data packets needed to fully describe it.
	 * 
	 * @param keyID
	 *            keyID associated with the public key.
	 * @param publicKeyPacket
	 *            the public key data packet to be associated with this private
	 *            key.
	 * @param privateKeyDataPacket
	 *            the private key data packet to be associate with this private
	 *            key.
	 */
	public PGPPrivateKey(long keyID, PublicKeyPacket publicKeyPacket,
	...
	public PrivateKey getKey() {
		...
		try {
			return new JcaPGPKeyConverter().setProvider(
					PGPUtil.getDefaultProvider()).getPrivateKey(this);
		} catch (PGPException e) {
			throw new IllegalStateException("unable to convert key: "
					+ e.toString());
		}
	}

	/**
	 * Return the public key packet associated with this private key, if
	 * available.
	 * 
	...
	/**
	 * Return the private key packet associated with this private key, if
	 * available.
	 * 
