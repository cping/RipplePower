...
class Tnaf {
	...
	public static byte[] tauAdicNaf(byte mu, ZTauElement lambda) {
		...
		while (!((r0.equals(ECConstants.ZERO)) && (r1.equals(ECConstants.ZERO)))) {
			// If r0 is odd
			if (r0.testBit(0)) {
				u[i] = (byte) ECConstants.TWO.subtract(
						(r0.subtract(r1.shiftLeft(1))).mod(ECConstants.FOUR))
						.intValue();
	...
	public static ECPoint.F2m tau(ECPoint.F2m p) {
		...
		return new ECPoint.F2m(p.getCurve(), x.square(), y.square(),
				p.isCompressed());
	}
	...
	/**
	 * Multiplies a {@link org.ripple.bouncycastle.math.ec.ECPoint.F2m
	 * ECPoint.F2m} by a <code>BigInteger</code> using the reduced
	 * <code>&tau;</code>-adic NAF (RTNAF) method.
	 * 
	 * @param p
	 *            The ECPoint.F2m to multiply.
	 * @param k
	 *            The <code>BigInteger</code> by which to multiply
	 *            <code>p</code>.
	...
	/**
	 * Multiplies a {@link org.ripple.bouncycastle.math.ec.ECPoint.F2m
	 * ECPoint.F2m} by an element <code>&lambda;</code> of
