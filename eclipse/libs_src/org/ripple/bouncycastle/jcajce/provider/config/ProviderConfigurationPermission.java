 ...
 * setting only</li>
 * <li>ProviderConfigurationPermission("BC",
 * "threadLocalEcImplicitlyCa, ecImplicitlyCa"); // enable both explicitly</li>
 * </ul>
 * <p>
...
public class ProviderConfigurationPermission extends BasicPermission {
	...
	private static final int ALL = THREAD_LOCAL_EC_IMPLICITLY_CA
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof ProviderConfigurationPermission) {
			...
			return this.permissionMask == other.permissionMask
