			...
			try {
				...
				if (bytes == null) {
					throw new InvalidKeyException(
							"no encoding for EC public key");
				}

				PublicKey publicKey = BouncyCastleProvider
	...
	public static AsymmetricKeyParameter generatePrivateKeyParameter(
		...
		if (key instanceof ECPrivateKey) {
			...
			try {
				...
				if (bytes == null) {
					throw new InvalidKeyException(
							"no encoding for EC private key");
				}

				PrivateKey privateKey = BouncyCastleProvider
						.getPrivateKey(PrivateKeyInfo.getInstance(bytes));
				...
				throw new InvalidKeyException(
						"cannot identify EC private key: " + e.toString());
			}
		}
