...
public class BCECPublicKey implements ECPublicKey,
	...
	public BCECPublicKey(String algorithm, ECPublicKeySpec spec,
	...
	public BCECPublicKey(String algorithm,
		...
		if (spec.getParams() != null) // can be null if implictlyCa
		{
			...
			if (q.getCurve() == null) {
				org.ripple.bouncycastle.jce.spec.ECParameterSpec s = configuration
						.getEcImplicitlyCa();
	...
	BCECPublicKey(String algorithm, SubjectPublicKeyInfo info,
			ProviderConfiguration configuration) {
		this.algorithm = algorithm;
		this.configuration = configuration;
	...
	public byte[] getEncoded() {
		...
		ASN1OctetString p = (ASN1OctetString) new X9ECPoint(curve.createPoint(
				this.getQ().getX().toBigInteger(), this.getQ().getY()
						.toBigInteger(), withCompression)).toASN1Primitive();
