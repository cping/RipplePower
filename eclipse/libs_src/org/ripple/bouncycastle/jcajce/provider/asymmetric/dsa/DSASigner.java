...
public class DSASigner extends SignatureSpi implements PKCSObjectIdentifiers,
	...
	private byte[] derEncode(BigInteger r, BigInteger s) throws IOException {
		ASN1Integer[] rs = new ASN1Integer[] { new ASN1Integer(r),
				new ASN1Integer(s) };
	...
	static public class stdDSA extends DSASigner {
		public stdDSA() {
			super(new SHA1Digest(),
					new org.ripple.bouncycastle.crypto.signers.DSASigner());
		}
	}
