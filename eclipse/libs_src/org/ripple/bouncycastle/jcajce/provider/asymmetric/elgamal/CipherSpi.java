...
public class CipherSpi extends BaseCipherSpi {
	...
	private void initFromSpec(OAEPParameterSpec pSpec)
		...
		cipher = new BufferedAsymmetricBlockCipher(new OAEPEncoding(
				new ElGamalEngine(), digest,
	...
	protected void engineSetPadding(String padding)
		...
		if (pad.equals("NOPADDING")) {
			...
			cipher = new BufferedAsymmetricBlockCipher(new PKCS1Encoding(
					new ElGamalEngine()));
		} else if (pad.equals("ISO9796-1PADDING")) {
			cipher = new BufferedAsymmetricBlockCipher(new ISO9796d1Encoding(
					new ElGamalEngine()));
	...
	protected void engineInit(int opmode, Key key, AlgorithmParameters params,
		...
		throw new InvalidAlgorithmParameterException(
				"can't handle parameters in ElGamal");
	}
