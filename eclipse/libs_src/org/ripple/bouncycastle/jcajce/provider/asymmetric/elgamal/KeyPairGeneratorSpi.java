...
public class KeyPairGeneratorSpi extends java.security.KeyPairGenerator {
	...
	public void initialize(AlgorithmParameterSpec params, SecureRandom random)
		...
		if (params instanceof ElGamalParameterSpec) {
			...
			param = new ElGamalKeyGenerationParameters(random,
					new ElGamalParameters(dhParams.getP(), dhParams.getG(),
							dhParams.getL()));
		}
	...
	public KeyPair generateKeyPair() {
		...
		ElGamalPublicKeyParameters pub = (ElGamalPublicKeyParameters) pair
				.getPublic();
		ElGamalPrivateKeyParameters priv = (ElGamalPrivateKeyParameters) pair
				.getPrivate();
