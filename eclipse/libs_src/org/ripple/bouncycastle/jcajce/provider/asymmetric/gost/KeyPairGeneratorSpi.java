...
public class KeyPairGeneratorSpi extends java.security.KeyPairGenerator {
	...
	private void init(GOST3410ParameterSpec gParams, SecureRandom random) {
		GOST3410PublicKeyParameterSetSpec spec = gParams
	...
	public void initialize(AlgorithmParameterSpec params, SecureRandom random)
		...
		if (!(params instanceof GOST3410ParameterSpec)) {
			throw new InvalidAlgorithmParameterException(
					"parameter object not a GOST3410ParameterSpec");
		}
	...
	public KeyPair generateKeyPair() {
		...
		GOST3410PublicKeyParameters pub = (GOST3410PublicKeyParameters) pair
				.getPublic();
		GOST3410PrivateKeyParameters priv = (GOST3410PrivateKeyParameters) pair
				.getPrivate();
