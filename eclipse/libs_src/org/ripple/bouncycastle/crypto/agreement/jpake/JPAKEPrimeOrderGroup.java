 ...
 * >publishes</a> many groups that can be used for the desired level of
 * security.
 */
public class JPAKEPrimeOrderGroup {
	 ...
	 * {@link BigInteger#isProbablePrime(int)}, and are therefore subject to the
	 * same probability guarantees.
	 * <p/>
	 * <p/>
	 * These checks prevent trivial mistakes. However, due to the small
	 * uncertainties if p and q are not prime, advanced attacks are not
	 * prevented. Use it at your own risk.
	 * 
	 ...
	 * expensive checks.
	 */
	JPAKEPrimeOrderGroup(BigInteger p, BigInteger q, BigInteger g,
			boolean skipChecks) {
		...
		if (!skipChecks) {
			...
			if (g.compareTo(BigInteger.valueOf(2)) == -1
					|| g.compareTo(p.subtract(JPAKEUtil.ONE)) == 1) {
