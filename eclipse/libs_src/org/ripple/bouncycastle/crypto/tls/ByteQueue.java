...
public class ByteQueue {
	...
	public static final int nextTwoPow(int i) {
		/*
		 * This code is based of a lot of code I found on the Internet which
		 * mostly referenced a book called "Hacking delight".
		 */
		i |= (i >> 1);
		i |= (i >> 2);
		i |= (i >> 4);
	...
	public void removeData(int i) {
		...
		/*
		 * If more than half of our data is skipped, we will move the data in
		 * the buffer.
		 */
