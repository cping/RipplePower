...
public abstract class DefaultTlsClient extends AbstractTlsClient {
	...
	public Hashtable getClientExtensions() throws IOException {
		...
		if (TlsECCUtils.containsECCCipherSuites(getCipherSuites())) {
			 ...
			 */
			this.namedCurves = new int[] { NamedCurve.secp256r1,
					NamedCurve.sect233r1, NamedCurve.secp224r1,
					NamedCurve.sect193r1, NamedCurve.secp192r1,
	...
	public void processServerExtensions(Hashtable serverExtensions)
		...
		if (serverExtensions != null) {
			int[] namedCurves = TlsECCUtils
					.getSupportedEllipticCurvesExtension(serverExtensions);
			if (namedCurves != null) {
