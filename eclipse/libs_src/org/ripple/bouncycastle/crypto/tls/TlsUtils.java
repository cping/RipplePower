...
public class TlsUtils {
	...
	public static Vector getSignatureAlgorithmsExtension(Hashtable extensions)
		...
		byte[] extensionValue = (byte[]) extensions
				.get(EXT_signature_algorithms);
	...
	static void validateKeyUsage(
			org.ripple.bouncycastle.asn1.x509.Certificate c, int keyUsageBits)
			throws IOException {
	...
	static short getClientCertificateType(Certificate clientCertificate,
		...
		org.ripple.bouncycastle.asn1.x509.Certificate x509Cert = clientCertificate
				.getCertificateAt(0);
