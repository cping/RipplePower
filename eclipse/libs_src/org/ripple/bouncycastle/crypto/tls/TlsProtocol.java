...
public abstract class TlsProtocol {
	...
	protected void completeHandshake() throws IOException {
		...
		this.writeExtraEmptyRecords = version
	...
	protected void writeData(byte[] buf, int offset, int len)
		...
		while (len > 0) {
			...
			if (this.writeExtraEmptyRecords) {
				 ...
				 * 
				 * DO NOT REMOVE THIS LINE, EXCEPT YOU KNOW EXACTLY WHAT YOU ARE
				 * DOING HERE.
				 */
				safeWriteRecord(ContentType.application_data,
						TlsUtils.EMPTY_BYTES, 0, 0);
			}
