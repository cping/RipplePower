...
public class TlsServerProtocol extends TlsProtocol {
	...
	protected void handleHandshakeMessage(short type, byte[] data)
		...
		case HandshakeType.client_hello: {
			...
			case CS_START: {
				...
				// TODO This block could really be done before actually sending
				// the hello
				{
					...
					/*
					 * RFC 5264 7.4.9. Any cipher suite which does not
					 * explicitly specify verify_data_length has a
					 * verify_data_length equal to 12. This includes all
				...
				if (this.serverCredentials == null) {
					...
					sendCertificateMessage(this.serverCredentials
							.getCertificate());
				}
		...
		case HandshakeType.client_key_exchange: {
			...
			case CS_CLIENT_SUPPLEMENTAL_DATA: {
				if (this.certificateRequest == null) {
					...
					ProtocolVersion equivalentTLSVersion = getContext()
	...
	protected void receiveCertificateVerifyMessage(ByteArrayInputStream buf)
		...
		try {
			...
			org.ripple.bouncycastle.asn1.x509.Certificate x509Cert = this.clientCertificate
					.getCertificateAt(0);
	...
	protected void receiveClientHelloMessage(ByteArrayInputStream buf)
		 ...
		 */
		{
			 ...
			 */
			if (arrayContains(offeredCipherSuites,
			...
			if (clientExtensions != null) {
				byte[] renegExtValue = (byte[]) clientExtensions
	...
	protected void sendServerHelloMessage() throws IOException {
		...
		this.selectedCompressionMethod = tlsServer
				.getSelectedCompressionMethod();
		if (!arrayContains(this.offeredCompressionMethods,
		...
		if (this.serverExtensions != null) {
			this.expectSessionTicket = serverExtensions
					.containsKey(EXT_SessionTicket);
