...
public interface AEADBlockCipher {
	 ...
	 * If the implementation supports it, this will be an online operation and
	 * will not retain the associated data.
	 * 
	 * @param in
	 ...
	 * @throws org.ripple.bouncycastle.crypto.InvalidCipherTextException
