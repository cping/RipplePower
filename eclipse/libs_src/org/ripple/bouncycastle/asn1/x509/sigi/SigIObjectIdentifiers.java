...
public interface SigIObjectIdentifiers {
	public final static ASN1ObjectIdentifier id_sigi = new ASN1ObjectIdentifier(
			"1.3.36.8");
	 ...
	 * Specification)
	 */
	public final static ASN1ObjectIdentifier id_sigi_kp = new ASN1ObjectIdentifier(
			id_sigi + ".2");
	 ...
	 * Specification)
	 */
	public final static ASN1ObjectIdentifier id_sigi_cp = new ASN1ObjectIdentifier(
			id_sigi + ".1");

	/**
	 * Other Name IDs for German SigI (Signature Interoperability Specification)
	 */
	public final static ASN1ObjectIdentifier id_sigi_on = new ASN1ObjectIdentifier(
			id_sigi + ".4");
