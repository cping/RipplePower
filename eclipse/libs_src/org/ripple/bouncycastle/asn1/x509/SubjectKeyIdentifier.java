...
public class SubjectKeyIdentifier extends ASN1Object {
	...
	public static SubjectKeyIdentifier fromExtensions(Extensions extensions) {
		return SubjectKeyIdentifier.getInstance(extensions
				.getExtensionParsedValue(Extension.subjectKeyIdentifier));
	}
	 ...
	 * @deprecated use
	 *             org.bouncycastle.cert.X509ExtensionUtils.createSubjectKeyIdentifier
	 */
	 ...
	 *            the key info object containing the subjectPublicKey field.
	 * @return the key identifier.
	 * @deprecated use org.bouncycastle.cert.X509ExtensionUtils.
