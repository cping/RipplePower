...
public class CertificateHolderAuthorization extends ASN1Object {
	ASN1ObjectIdentifier oid;
	DERApplicationSpecific accessRights;
	public static final ASN1ObjectIdentifier id_role_EAC = EACObjectIdentifiers.bsi_de
			.branch("3.1.2.1");
	...
	private void setPrivateData(ASN1InputStream cha) throws IOException {
		...
		if (obj instanceof DERApplicationSpecific) {
			...
			throw new IllegalArgumentException(
					"No access rights in CerticateHolderAuthorization");
		}
	}
	...
	public ASN1Primitive toASN1Primitive() {
		...
		return new DERApplicationSpecific(
				EACTags.CERTIFICATE_HOLDER_AUTHORIZATION_TEMPLATE, v);
	}
}
