...
public class TBSRequest extends ASN1Object {
	 ...
	 */
	public TBSRequest(GeneralName requestorName, ASN1Sequence requestList,
	...
	private TBSRequest(ASN1Sequence seq) {
		...
		if (seq.getObjectAt(index) instanceof ASN1TaggedObject) {
			requestorName = GeneralName.getInstance(
		...
		if (seq.size() == (index + 1)) {
			requestExtensions = Extensions.getInstance(
					(ASN1TaggedObject) seq.getObjectAt(index), true);
		}
	}
	...
	public ASN1Primitive toASN1Primitive() {
		...
		//
		// if default don't include - unless explicitly provided. Not strictly
		// correct
