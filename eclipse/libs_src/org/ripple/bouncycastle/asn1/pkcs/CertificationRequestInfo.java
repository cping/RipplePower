...
public class CertificationRequestInfo extends ASN1Object {
	 ...
	 * should always at least contain an empty set. If a fully compliant request
	 * is required, pass in an empty set, the class will otherwise interpret a
	 * null as it should encode the request with the field missing.
	 * </p>
	 * 
	 * @param subject
