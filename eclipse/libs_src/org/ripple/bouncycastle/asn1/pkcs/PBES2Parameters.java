...
public class PBES2Parameters extends ASN1Object implements
	...
	public PBES2Parameters(KeyDerivationFunc keyDevFunc,
	...
	private PBES2Parameters(ASN1Sequence obj) {
		...
		ASN1Sequence funcSeq = ASN1Sequence.getInstance(((ASN1Encodable) e
				.nextElement()).toASN1Primitive());

		if (funcSeq.getObjectAt(0).equals(id_PBKDF2)) {
			func = new KeyDerivationFunc(id_PBKDF2,
