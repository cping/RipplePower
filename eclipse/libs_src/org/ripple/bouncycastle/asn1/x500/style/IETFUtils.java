...
public class IETFUtils {
	...
	public static RDN[] rDNsFromString(String name, X500NameStyle x500Style) {
		...
		while (nTok.hasMoreTokens()) {
			...
			if (token.indexOf('+') > 0) {
				...
				X500NameTokenizer vTok = new X500NameTokenizer(
						pTok.nextToken(), '=');
	...
	public static String[] findAttrNamesForOID(ASN1ObjectIdentifier oid,
			Hashtable lookup) {
		int count = 0;
	...
	public static String valueToString(ASN1Encodable value) {
		...
		if (value instanceof ASN1String
			...
			try {
				vBuf.append("#"
						+ bytesToString(Hex.encode(value.toASN1Primitive()
	...
	private static boolean atvAreEqual(AttributeTypeAndValue atv1,
		...
		String v1 = IETFUtils.canonicalize(IETFUtils.valueToString(atv1
				.getValue()));
		String v2 = IETFUtils.canonicalize(IETFUtils.valueToString(atv2
				.getValue()));
