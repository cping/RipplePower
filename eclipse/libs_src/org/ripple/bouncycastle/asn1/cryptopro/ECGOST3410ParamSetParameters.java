...
public class ECGOST3410ParamSetParameters extends ASN1Object {
	...
	public static ECGOST3410ParamSetParameters getInstance(Object obj) {
		...
		throw new IllegalArgumentException("Invalid GOST3410Parameter: "
				+ obj.getClass().getName());
	}

	public ECGOST3410ParamSetParameters(BigInteger a, BigInteger b,
			BigInteger p, BigInteger q, int x, BigInteger y) {
