...
public interface UAObjectIdentifiers {
	...
	static final ASN1ObjectIdentifier UaOid = new ASN1ObjectIdentifier(
			"1.2.804.2.1.1.1");

	// {pki-alg(1) pki-alg-�sym(3) Dstu4145WithGost34311(1) PB(1)}
	// DSTU4145 in polynomial basis has 2 oids, one for little-endian
	// representation and one for big-endian
