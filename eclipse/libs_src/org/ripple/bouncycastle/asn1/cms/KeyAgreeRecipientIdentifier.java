...
public class KeyAgreeRecipientIdentifier extends ASN1Object implements
		ASN1Choice {
	...
	public static KeyAgreeRecipientIdentifier getInstance(Object obj) {
		...
		if (obj instanceof ASN1Sequence) {
			return new KeyAgreeRecipientIdentifier(
					IssuerAndSerialNumber.getInstance(obj));
		}

		if (obj instanceof ASN1TaggedObject
				&& ((ASN1TaggedObject) obj).getTagNo() == 0) {
			return new KeyAgreeRecipientIdentifier(
					RecipientKeyIdentifier.getInstance((ASN1TaggedObject) obj,
							false));
		}

		throw new IllegalArgumentException(
				"Invalid KeyAgreeRecipientIdentifier: "
