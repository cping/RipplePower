...
public class ProfessionInfo extends ASN1Object {
	...
	private ProfessionInfo(ASN1Sequence seq) {
		...
		if (o instanceof ASN1TaggedObject) {
			...
			namingAuthority = NamingAuthority.getInstance((ASN1TaggedObject) o,
					true);
	...
	public ProfessionInfo(NamingAuthority namingAuthority,
			...
			ASN1ObjectIdentifier[] professionOIDs, String registrationNumber,
	...
	public ASN1ObjectIdentifier[] getProfessionOIDs() {
		...
		ASN1ObjectIdentifier[] oids = new ASN1ObjectIdentifier[professionOIDs
				.size()];
		int count = 0;
