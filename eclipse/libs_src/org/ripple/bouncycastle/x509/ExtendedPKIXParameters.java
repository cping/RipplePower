...
public class ExtendedPKIXParameters extends PKIXParameters {
	...
	/**
	 * Adds an additional Bouncy Castle {@link Store} to find CRLs,
	 * certificates, attribute certificates or cross certificates.
	 * <p>
	 ...
	 * 
	 * @param selector
	 *            a <code>Selector</code> specifying the constraints on the
	 *            target certificate or attribute certificate (or
	 *            <code>null</code>)
	 ...
	 * 
	 * @param selector
	 *            a <code>X509CertSelector</code> specifying the constraints on
	 *            the target certificate (or <code>null</code>)
