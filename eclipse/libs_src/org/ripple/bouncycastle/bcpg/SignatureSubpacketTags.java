...
public interface SignatureSubpacketTags {
	...
	public static final int PLACEHOLDER = 10; // placeholder for backward
												// compatibility
	public static final int PREFERRED_SYM_ALGS = 11; // preferred symmetric
														// algorithms
	...
	public static final int PREFERRED_HASH_ALGS = 21; // preferred hash
														// algorithms
	public static final int PREFERRED_COMP_ALGS = 22; // preferred compression
														// algorithms
