...
public interface PacketTags {
	public static final int RESERVED = 0; // Reserved - a packet tag must not
											// have this value
	public static final int PUBLIC_KEY_ENC_SESSION = 1; // Public-Key Encrypted
														// Session Key Packet
	public static final int SIGNATURE = 2; // Signature Packet
	public static final int SYMMETRIC_KEY_ENC_SESSION = 3; // Symmetric-Key
															// Encrypted Session
															// Key Packet
	...
	public static final int SYMMETRIC_KEY_ENC = 9; // Symmetrically Encrypted
													// Data Packet
	...
	public static final int SYM_ENC_INTEGRITY_PRO = 18; // Symmetric encrypted,
														// integrity protected
	public static final int MOD_DETECTION_CODE = 19; // Modification detection
														// code

	public static final int EXPERIMENTAL_1 = 60; // Private or Experimental
													// Values
