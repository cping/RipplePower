...
/**
 * specification signifying that the curve parameters can also be refered to by
 * name.
 * <p>
...
public class ECNamedCurveParameterSpec extends ECParameterSpec {
	...
	public ECNamedCurveParameterSpec(String name, ECCurve curve, ECPoint G,
			BigInteger n) {
		super(curve, G, n);
	...
	public ECNamedCurveParameterSpec(String name, ECCurve curve, ECPoint G,
			BigInteger n, BigInteger h, byte[] seed) {
