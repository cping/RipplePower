...
public class GOST3410ParameterSpec implements AlgorithmParameterSpec,
	...
	public GOST3410ParameterSpec(String keyParamSetID,
			String digestParamSetOID, String encryptionParamSetOID) {
		GOST3410ParamSetParameters ecP = null;

		try {
			ecP = GOST3410NamedParameters.getByOID(new ASN1ObjectIdentifier(
					keyParamSetID));
		} catch (IllegalArgumentException e) {
			ASN1ObjectIdentifier oid = GOST3410NamedParameters
					.getOID(keyParamSetID);
			if (oid != null) {
		...
		this.keyParameters = new GOST3410PublicKeyParameterSetSpec(ecP.getP(),
				ecP.getQ(), ecP.getA());
	...
	public GOST3410ParameterSpec(GOST3410PublicKeyParameterSetSpec spec) {
		...
		this.digestParamSetOID = CryptoProObjectIdentifiers.gostR3411_94_CryptoProParamSet
				.getId();
	...
	public boolean equals(Object o) {
		if (o instanceof GOST3410ParameterSpec) {
			...
			return this.keyParameters.equals(other.keyParameters)
					...
					&& (this.encryptionParamSetOID == other.encryptionParamSetOID || (this.encryptionParamSetOID != null && this.encryptionParamSetOID
							.equals(other.encryptionParamSetOID)));
		}
	...
	public int hashCode() {
		return this.keyParameters.hashCode()
				...
				^ (this.encryptionParamSetOID != null ? this.encryptionParamSetOID
						.hashCode() : 0);
	}
	...
	public static GOST3410ParameterSpec fromPublicKeyAlg(
		...
		if (params.getEncryptionParamSet() != null) {
			return new GOST3410ParameterSpec(params.getPublicKeyParamSet()
					.getId(), params.getDigestParamSet().getId(), params
					.getEncryptionParamSet().getId());
		} else {
			return new GOST3410ParameterSpec(params.getPublicKeyParamSet()
					.getId(), params.getDigestParamSet().getId());
		}
	}
}
