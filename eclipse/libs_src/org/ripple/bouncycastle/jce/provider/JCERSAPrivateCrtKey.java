 ...
 */
public class JCERSAPrivateCrtKey extends JCERSAPrivateKey implements
		RSAPrivateCrtKey {
	...
	JCERSAPrivateCrtKey(PrivateKeyInfo info) throws IOException {
		this(org.ripple.bouncycastle.asn1.pkcs.RSAPrivateKey.getInstance(info
				.parsePrivateKey()));
	}
	...
	public byte[] getEncoded() {
		return KeyUtil.getEncodedPrivateKeyInfo(new AlgorithmIdentifier(
				...
				new RSAPrivateKey(getModulus(), getPublicExponent(),
