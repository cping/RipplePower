...
public class JCEECPrivateKey implements ECPrivateKey,
	...
	public JCEECPrivateKey(String algorithm,
	...
	public JCEECPrivateKey(String algorithm, ECPrivateKeyParameters params,
			JCEECPublicKey pubKey, ECParameterSpec spec) {
	...
	public byte[] getEncoded() {
		...
		if (publicKey != null) {
			keyStructure = new ECPrivateKeyStructure(this.getS(), publicKey,
					params);
		} else {
