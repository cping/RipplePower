 ...
 * {@link org.ripple.bouncycastle.x509.X509Store} SPI implementation for
 * certificate pairs.
 * 
...
public class X509StoreCertPairCollection extends X509StoreSpi {
	 ...
	 * {@link org.ripple.bouncycastle.x509.X509CertificatePair}s. The selector
	 * must be a {@link org.ripple.bouncycastle.x509.X509CertPairStoreSelector}
