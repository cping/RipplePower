...
class BouncyCastleProviderConfiguration implements ProviderConfiguration {
	...
	void setParameter(String parameterName, Object parameter) {
		...
		if (parameterName
				.equals(ConfigurableProvider.THREAD_LOCAL_EC_IMPLICITLY_CA)) {
			...
			{
				curveSpec = EC5Util.convertSpec(
						(java.security.spec.ECParameterSpec) parameter, false);
			}
			...
			{
				ecImplicitCaParams = EC5Util.convertSpec(
						(java.security.spec.ECParameterSpec) parameter, false);
			}
		} else if (parameterName
				.equals(ConfigurableProvider.THREAD_LOCAL_DH_DEFAULT_PARAMS)) {
			Object dhSpec;
