...
public class X509AttrCertParser extends X509StreamParserSpi {
	private static final PEMUtil PEM_PARSER = new PEMUtil(
		...
		if (sData != null) {
			while (sDataObjectCount < sData.size()) {
				...
				if (obj instanceof ASN1TaggedObject
						&& ((ASN1TaggedObject) obj).getTagNo() == 2) {
					return new X509V2AttributeCertificate(ASN1Sequence
							.getInstance((ASN1TaggedObject) obj, false)
							.getEncoded());
				}
			}
		}
