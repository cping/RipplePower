...
public class PKIXAttrCertPathValidatorSpi extends CertPathValidatorSpi {
	...
	public CertPathValidatorResult engineValidate(CertPath certPath,
		...
		if (!(params instanceof ExtendedPKIXParameters)) {
			throw new InvalidAlgorithmParameterException(
					"Parameters must be a "
							+ ExtendedPKIXParameters.class.getName()
							+ " instance.");
		}
		...
		CertPath holderCertPath = RFC3281CertPathUtilities.processAttrCert1(
				attrCert, pkixParams);
		CertPathValidatorResult result = RFC3281CertPathUtilities
				.processAttrCert2(certPath, pkixParams);
		...
		RFC3281CertPathUtilities.processAttrCert7(attrCert, certPath,
				holderCertPath, pkixParams);
		...
		RFC3281CertPathUtilities.checkCRLs(attrCert, pkixParams, issuerCert,
				date, certPath.getCertificates());
		return result;
	}
}
