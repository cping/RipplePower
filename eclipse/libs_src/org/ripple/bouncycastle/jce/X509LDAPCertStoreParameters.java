 ...
 */
public class X509LDAPCertStoreParameters implements X509StoreParameters,
		CertStoreParameters {
	...
	public static class Builder {
		 ...
		 *            Attribute name(s) in the LDAP directory where end
		 ...
		 * @return the builder
		 */
		public Builder setUserCertificateAttribute(
				String userCertificateAttribute) {
		 ...
		 *            Attribute name(s) in the LDAP directory where CA
		 *            certificates are stored. Separated by space. Defaults to
		 *            "cACertificate" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s), where the cross certificates are
		 *            stored. Separated by space. Defaults to
		 *            "crossCertificatePair" if <code>null</code>
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setCrossCertificateAttribute(
				String crossCertificateAttribute) {
		 ...
		 *            Attribute name(s) in the LDAP directory where CRLs are
		 *            stored. Separated by space. Defaults to
		 *            "certificateRevocationList" if <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            Attribute name(s) in the LDAP directory where delta RLs
		 ...
		 * @return the builder
		 */
		public Builder setDeltaRevocationListAttribute(
				String deltaRevocationListAttribute) {
		 ...
		 * @return the builder
		 */
		public Builder setAuthorityRevocationListAttribute(
				String authorityRevocationListAttribute) {
		 ...
		 *            Defaults to "attributeCertificateAttribute" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            certificates for attribute authorities are stored.
		 *            Separated by space. Defaults to "aACertificate" if
		 *            <code>null</code>.
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            attribute certificates for attribute authorities are
		 *            stored. Separated by space. Defaults to
		 ...
		 *            The attribute name(s) in the LDAP directory where to
		 ...
		 * @return the builder
		 */
		public Builder setLdapUserCertificateAttributeName(
				String ldapUserCertificateAttributeName) {
		 ...
		 * @return the builder
		 */
		public Builder setLdapCACertificateAttributeName(
		 ...
		 * @return the builder
		 */
		public Builder setLdapCrossCertificateAttributeName(
		 ...
		 *            E.g. if "ou" is used to put information about the issuer
		 *            of CRLs, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            if "ou" is used to put information about the issuer of
		 *            CRLs, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            . E.g. if "cn" is used to put information about the
		 *            subject of end attribute certificates, specify "cn".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		 ...
		 *            attribute authority attribute certificates, specify "ou".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 */
		public Builder setLdapAACertificateAttributeName(
				String ldapAACertificateAttributeName) {
		 ...
		 *            . E.g. if "o" is used to put information about the subject
		 *            of self signed attribute authority attribute certificates,
		 *            specify "o".
		 * @throws IllegalArgumentException
		 *             if a necessary parameter is <code>null</code>.
		 * @return the builder
		 ...
		 *            Attribute(s) in the subject of the certificate which is
		 ...
		 * @return the builder
		 */
		public Builder setCACertificateSubjectAttributeName(
		 ...
		 *            Attribute(s) in the subject of the cross certificate which
		 ...
		 *            Attribute(s) in the issuer of the CRL which is used to be
		 *            searched in the
		 *            <code>ldapDeltaRevocationListAttributeName</code>. E.g.
		 ...
		 *            Attribute(s) in the subject of the attribute certificate
		 ...
		 * @return the builder
		 */
		public Builder setAACertificateSubjectAttributeName(
				String aACertificateSubjectAttributeName) {
		 ...
		 *            . E.g. the "o" or "ou" attribute may be used certificate
	...
	public boolean equal(Object o) {
		...
		return checkField(ldapURL, params.ldapURL)
				...
				&& checkField(userCertificateAttribute,
						params.userCertificateAttribute)
				&& checkField(cACertificateAttribute,
						params.cACertificateAttribute)
				&& checkField(crossCertificateAttribute,
						params.crossCertificateAttribute)
				&& checkField(certificateRevocationListAttribute,
						params.certificateRevocationListAttribute)
				&& checkField(deltaRevocationListAttribute,
						params.deltaRevocationListAttribute)
				&& checkField(authorityRevocationListAttribute,
						params.authorityRevocationListAttribute)
				&& checkField(attributeCertificateAttributeAttribute,
						params.attributeCertificateAttributeAttribute)
				&& checkField(aACertificateAttribute,
						params.aACertificateAttribute)
				...
				&& checkField(ldapUserCertificateAttributeName,
						params.ldapUserCertificateAttributeName)
				&& checkField(ldapCACertificateAttributeName,
						params.ldapCACertificateAttributeName)
				&& checkField(ldapCrossCertificateAttributeName,
				...
				&& checkField(ldapAACertificateAttributeName,
						params.ldapAACertificateAttributeName)
				...
				&& checkField(cACertificateSubjectAttributeName,
						params.cACertificateSubjectAttributeName)
				...
				&& checkField(aACertificateSubjectAttributeName,
						params.aACertificateSubjectAttributeName)
				&& checkField(
				...
				&& checkField(searchForSerialNumberIn,
						params.searchForSerialNumberIn);
	}
	...
	public static X509LDAPCertStoreParameters getInstance(
			LDAPCertStoreParameters params) {
		String server = "ldap://" + params.getServerName() + ":"
				+ params.getPort();
