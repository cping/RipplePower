...
public class CipherOutputStream extends FilterOutputStream {
	 ...
	 * output stream.
	 * <p/>
	 * The <code>write</code> method of <code>CipherOutputStream</code> calls
	 * the <code>write</code> method of three arguments with the three arguments
	...
	private void ensureCapacity(int outputSize) {
		// This overestimates buffer on updates for AEAD/padded, but keeps it
		// simple.
		int bufLen;
		if (bufferedBlockCipher != null) {
	 ...
	 * and calls the <code>close</code> method of the underlying output stream.
	 * 
	 * @throws java.io.IOException
	 *             if an I/O error occurs.
	...
	public void close() throws IOException {
		...
		try {
			...
			error = new InvalidCipherTextIOException(
					"Error finalising cipher data", e);
		} catch (Exception e) {
