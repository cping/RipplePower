...
public class PrivateKeyFactory {
	...
	public static AsymmetricKeyParameter createKey(byte[] privateKeyInfoData)
			throws IOException {
		return createKey(PrivateKeyInfo.getInstance(ASN1Primitive
	...
	public static AsymmetricKeyParameter createKey(InputStream inStr)
			throws IOException {
		return createKey(PrivateKeyInfo.getInstance(new ASN1InputStream(inStr)
				.readObject()));
	}
	...
	public static AsymmetricKeyParameter createKey(PrivateKeyInfo keyInfo)
		...
		if (algId.getAlgorithm().equals(PKCSObjectIdentifiers.rsaEncryption)) {
			RSAPrivateKey keyStructure = RSAPrivateKey.getInstance(keyInfo
					.parsePrivateKey());
			...
			return new RSAPrivateCrtKeyParameters(keyStructure.getModulus(),
					...
					keyStructure.getPrime1(), keyStructure.getPrime2(),
					keyStructure.getExponent1(), keyStructure.getExponent2(),
		...
		// (algId.getObjectId().equals(X9ObjectIdentifiers.dhpublicnumber))
			...
			ECPrivateKey ec = ECPrivateKey.getInstance(keyInfo
					.parsePrivateKey());
