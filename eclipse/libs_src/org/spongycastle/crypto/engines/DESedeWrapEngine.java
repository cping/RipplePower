...
/**
 * Wrap keys according to <A
 * HREF="http://www.ietf.org/internet-drafts/draft-ietf-smime-key-wrap-01.txt">
...
public class DESedeWrapEngine implements Wrapper {
	...
	private static final byte[] IV2 = { (byte) 0x4a, (byte) 0xdd, (byte) 0xa2,
			(byte) 0x2c, (byte) 0x79, (byte) 0xe8, (byte) 0x21, (byte) 0x05 };
	...
	public byte[] unwrap(byte[] in, int inOff, int inLen)
		...
		for (int currentBytePos = 0; currentBytePos != inLen; currentBytePos += blockSize) {
			engine.processBlock(in, inOff + currentBytePos, TEMP3,
					currentBytePos);
		}
		...
		// Decompose WKCKS. CKS is the last 8 octets and WK, the wrapped key,
		// are
