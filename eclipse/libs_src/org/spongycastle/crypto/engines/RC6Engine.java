...
public class RC6Engine implements BlockCipher {
	...
	public void init(boolean forEncryption, CipherParameters params) {
		if (!(params instanceof KeyParameter)) {
			throw new IllegalArgumentException(
					"invalid parameter passed to RC6 init - "
	 ...
	 * <em>lg(wordSize)</em> low-order bits of <em>y</em> are used to determine
	 * the rotation amount. Here it is assumed that the wordsize used is 32.
	 * <p>
	 * 
	 * @param x
	 *            word to rotate
	 ...
	 * <em>x</em> is rotated left by <em>y</em> bits. Only the
	 * <em>lg(wordSize)</em> low-order bits of <em>y</em> are used to determine
	 * the rotation amount. Here it is assumed that the wordsize used is a power
	 * of 2.
	 * <p>
	 * 
	 * @param x
