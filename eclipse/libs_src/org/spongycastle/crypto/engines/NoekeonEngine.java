...
public class NoekeonEngine implements BlockCipher {
	private static final int genericSize = 16; // Block and key size, as well as
												// the amount of rounds.

	private static final int[] nullVector = { 0x00, 0x00, 0x00, 0x00 // Used in
																		// decryption
			},

			roundConstants = { 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab, 0x4d, 0x9a,
	...
	public void init(boolean forEncryption, CipherParameters params) {
		if (!(params instanceof KeyParameter)) {
			throw new IllegalArgumentException(
					"invalid parameter passed to Noekeon init - "
