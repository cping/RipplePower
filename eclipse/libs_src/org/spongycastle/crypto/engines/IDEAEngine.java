 ...
 * "HOWTO: INTERNATIONAL DATA ENCRYPTION ALGORITHM" implementation summary by
 * Fauzan Mirza (F.U.Mirza@sheffield.ac.uk). (baring 1 typo at the end of the
 * mulinv function!).
 * <p>
 ...
 * commercial products are liable for royalties. Please see <a
 * href="http://www.mediacrypt.com">www.mediacrypt.com</a> for further details.
 * This announcement has been included at the request of the patent holders.
 * <p>
...
public class IDEAEngine implements BlockCipher {
	...
	public void init(boolean forEncryption, CipherParameters params) {
		...
		throw new IllegalArgumentException(
				"invalid parameter passed to IDEA init - "
	...
	private void ideaFunc(int[] workingKey, byte[] in, int inOff, byte[] out,
			int outOff) {
