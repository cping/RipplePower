...
public class ThreefishEngine implements BlockCipher {
	...
	/**
	 * Tweak bytes (2 byte t1,t2, calculated t3 and repeat of t1,t2 for modulo
	 * free lookup
	 */
	...
	public ThreefishEngine(final int blocksizeBits) {
		...
		/*
		 * Provide room for original key words, extended key word and repeat of
		 * key words for modulo free lookup of key schedule words.
		 */
	...
	public void init(boolean forEncryption, CipherParameters params)
		...
		if (tweakBytes != null) {
			if (tweakBytes.length != TWEAK_SIZE_BYTES) {
				throw new IllegalArgumentException("Threefish tweak must be "
						+ TWEAK_SIZE_BYTES + " bytes");
			}
			tweakWords = new long[] { bytesToWord(tweakBytes, 0),
	 ...
	 *            the cipher mode.
	 * @param key
	 *            the words of the key, or <code>null</code> to use the current
	 *            key.
	 * @param tweak
	...
	private void setKey(long[] key) {
		...
		/*
		 * Full subkey schedule is deferred to execution to avoid per cipher
		 * overhead (10k for 512, 20k for 1024).
		 * 
		 * Key and tweak word sequences are repeated, and static
		 * MOD17/MOD9/MOD5/MOD3 calculations used, to avoid expensive mod
		 * computations during cipher operation.
		 */
	...
	private void setTweak(long[] tweak) {
		if (tweak.length != TWEAK_SIZE_WORDS) {
			throw new IllegalArgumentException("Tweak must be "
					+ TWEAK_SIZE_WORDS + " words.");
		}

		/*
		 * Tweak schedule partially repeated to avoid mod computations during
		 * cipher operation
		 */
		t[0] = tweak[0];
		t[1] = tweak[1];
	 ...
	 *            operation.
	 * @return the number of 8 byte words processed (which will be the same as
	 *         the block size).
	 ...
	 */
	// At least package protected for efficient access from inner class
	public static void wordToBytes(final long word, final byte[] bytes,
			final int off) {
		if ((off + 8) > bytes.length) {
			// Help the JIT avoid index checks
			throw new IllegalArgumentException();
	...
	private static final class Threefish256Cipher extends ThreefishCipher {
		...
		void encryptBlock(long[] block, long[] out) {
			 ...
			 * 
			 * Unrolling to multiples of 4 avoids the mod 4 check for key
			 * injection, and allows inlining of the permutations, which cycle
			 * every of 2 rounds (avoiding array index/lookup).
			 * 
			 * Unrolling to multiples of 8 avoids the mod 8 rotation constant
			 * lookup, and allows inlining constant rotation values (avoiding
			 * array index/lookup).
			 */
			...
			for (int d = 1; d < (ROUNDS_256 / 4); d += 2) {
				 ...
				 * 
				 * Permute schedule has a 2 round cycle, so permutes are inlined
				 * in the mix operations in each 4 round block.
				 */
	...
	private static final class Threefish512Cipher extends ThreefishCipher {
		 ...
		 * Mix rotation constants defined in Skein 1.3 specification
		 */
		private static final int ROTATION_0_0 = 46, ROTATION_0_1 = 36,
				ROTATION_0_2 = 19, ROTATION_0_3 = 37;
		private static final int ROTATION_1_0 = 33, ROTATION_1_1 = 27,
				ROTATION_1_2 = 14, ROTATION_1_3 = 42;
		private static final int ROTATION_2_0 = 17, ROTATION_2_1 = 49,
				ROTATION_2_2 = 36, ROTATION_2_3 = 39;
		private static final int ROTATION_3_0 = 44, ROTATION_3_1 = 9,
				ROTATION_3_2 = 54, ROTATION_3_3 = 56;

		private static final int ROTATION_4_0 = 39, ROTATION_4_1 = 30,
				ROTATION_4_2 = 34, ROTATION_4_3 = 24;
		private static final int ROTATION_5_0 = 13, ROTATION_5_1 = 50,
				ROTATION_5_2 = 10, ROTATION_5_3 = 17;
		private static final int ROTATION_6_0 = 25, ROTATION_6_1 = 29,
				ROTATION_6_2 = 39, ROTATION_6_3 = 43;
		private static final int ROTATION_7_0 = 8, ROTATION_7_1 = 35,
				ROTATION_7_2 = 56, ROTATION_7_3 = 22;
		...
		public void encryptBlock(long[] block, long[] out) {
			 ...
			 * Unrolling to multiples of 4 avoids the mod 4 check for key
			 * injection, and allows inlining of the permutations, which cycle
			 * every of 4 rounds (avoiding array index/lookup).
			 * 
			 * Unrolling to multiples of 8 avoids the mod 8 rotation constant
			 * lookup, and allows inlining constant rotation values (avoiding
			 * array index/lookup).
			...
			for (int d = 1; d < (ROUNDS_512 / 4); d += 2) {
				 ...
				 * 4 rounds of mix and permute.
				 * 
				 * Permute schedule has a 4 round cycle, so permutes are inlined
				 * in the mix operations in each 4 round block.
				 */
				b1 = rotlXor(b1, ROTATION_0_0, b0 += b1);
				b3 = rotlXor(b3, ROTATION_0_1, b2 += b3);
	...
	private static final class Threefish1024Cipher extends ThreefishCipher {
		 ...
		 * Mix rotation constants defined in Skein 1.3 specification
		 */
		private static final int ROTATION_0_0 = 24, ROTATION_0_1 = 13,
				ROTATION_0_2 = 8, ROTATION_0_3 = 47;
		private static final int ROTATION_0_4 = 8, ROTATION_0_5 = 17,
				ROTATION_0_6 = 22, ROTATION_0_7 = 37;
		private static final int ROTATION_1_0 = 38, ROTATION_1_1 = 19,
				ROTATION_1_2 = 10, ROTATION_1_3 = 55;
		private static final int ROTATION_1_4 = 49, ROTATION_1_5 = 18,
				ROTATION_1_6 = 23, ROTATION_1_7 = 52;
		private static final int ROTATION_2_0 = 33, ROTATION_2_1 = 4,
				ROTATION_2_2 = 51, ROTATION_2_3 = 13;
		private static final int ROTATION_2_4 = 34, ROTATION_2_5 = 41,
				ROTATION_2_6 = 59, ROTATION_2_7 = 17;
		private static final int ROTATION_3_0 = 5, ROTATION_3_1 = 20,
				ROTATION_3_2 = 48, ROTATION_3_3 = 41;
		private static final int ROTATION_3_4 = 47, ROTATION_3_5 = 28,
				ROTATION_3_6 = 16, ROTATION_3_7 = 25;

		private static final int ROTATION_4_0 = 41, ROTATION_4_1 = 9,
				ROTATION_4_2 = 37, ROTATION_4_3 = 31;
		private static final int ROTATION_4_4 = 12, ROTATION_4_5 = 47,
				ROTATION_4_6 = 44, ROTATION_4_7 = 30;
		private static final int ROTATION_5_0 = 16, ROTATION_5_1 = 34,
				ROTATION_5_2 = 56, ROTATION_5_3 = 51;
		private static final int ROTATION_5_4 = 4, ROTATION_5_5 = 53,
				ROTATION_5_6 = 42, ROTATION_5_7 = 41;
		private static final int ROTATION_6_0 = 31, ROTATION_6_1 = 44,
				ROTATION_6_2 = 47, ROTATION_6_3 = 46;
		private static final int ROTATION_6_4 = 19, ROTATION_6_5 = 42,
				ROTATION_6_6 = 44, ROTATION_6_7 = 25;
		private static final int ROTATION_7_0 = 9, ROTATION_7_1 = 48,
				ROTATION_7_2 = 35, ROTATION_7_3 = 52;
		private static final int ROTATION_7_4 = 23, ROTATION_7_5 = 31,
				ROTATION_7_6 = 37, ROTATION_7_7 = 20;
		...
		void encryptBlock(long[] block, long[] out) {
			...
			/*
			 * Read 16 words of plaintext data, not using arrays for cipher
			 * state
			 */
			long b0 = block[0];
			long b1 = block[1];
