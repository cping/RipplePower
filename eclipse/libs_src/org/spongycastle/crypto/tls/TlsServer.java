...
public interface TlsServer extends TlsPeer {
	...
	/**
	 * This method will be called (only) if the server included an extension of
	 * type "status_request" with empty "extension_data" in the extended server
	 * hello. See <i>RFC 3546 3.6. Certificate Status Request</i>. If a non-null
	 ...
	 * 
	 * Note: this method is responsible for certificate verification and
	 * validation.
	 * 
	 ...
	 * <p/>
	 * This method will be called (only) if a NewSessionTicket extension was
	 * sent by the server. See <i>RFC 5077 4. Recommended Ticket
	 * Construction</i> for recommended format and protection.
	 * 
	 * @return The ticket.
	 * @throws IOException
	 */
