...
public class TlsDHUtils {
	...
	public static byte[] calculateDHBasicAgreement(
		...
		/*
		 * RFC 5246 8.1.2. Leading bytes of Z that contain all zero bits are
	...
	public static AsymmetricCipherKeyPair generateDHKeyPair(
			SecureRandom random, DHParameters dhParams) {
	...
	public static DHPrivateKeyParameters generateEphemeralClientKeyExchange(
			SecureRandom random, DHParameters dhParams, OutputStream output)
			throws IOException {
		AsymmetricCipherKeyPair kp = generateDHKeyPair(random, dhParams);

		DHPublicKeyParameters dh_public = (DHPublicKeyParameters) kp
				.getPublic();
	...
	public static DHPrivateKeyParameters generateEphemeralServerKeyExchange(
			SecureRandom random, DHParameters dhParams, OutputStream output)
			throws IOException {
		AsymmetricCipherKeyPair kp = TlsDHUtils.generateDHKeyPair(random,
				dhParams);

		DHPublicKeyParameters dhPublicKey = (DHPublicKeyParameters) kp
				.getPublic();
	...
	public static DHPublicKeyParameters validateDHPublicKey(
