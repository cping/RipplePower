...
public abstract class PSKTlsClient extends AbstractTlsClient {
	...
	public TlsKeyExchange getKeyExchange() throws IOException {
		...
		default:
			 ...
			 * verifies that the server-selected cipher suite was in the list of
			 * client-offered cipher suites, so if we now can't produce an
	...
	public TlsCipher getCipher() throws IOException {
		...
		case CipherSuite.TLS_PSK_WITH_AES_128_CCM:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.AES_128_CCM, MACAlgorithm._null);

		case CipherSuite.TLS_PSK_DHE_WITH_AES_128_CCM_8:
		case CipherSuite.TLS_PSK_WITH_AES_128_CCM_8:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.AES_128_CCM_8, MACAlgorithm._null);
		...
		case CipherSuite.TLS_PSK_WITH_AES_256_CCM:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.AES_256_CCM, MACAlgorithm._null);

		case CipherSuite.TLS_PSK_DHE_WITH_AES_256_CCM_8:
		case CipherSuite.TLS_PSK_WITH_AES_256_CCM_8:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.AES_256_CCM_8, MACAlgorithm._null);
		...
		case CipherSuite.TLS_RSA_PSK_WITH_ESTREAM_SALSA20_SHA1:
			return cipherFactory
					.createCipher(context, EncryptionAlgorithm.ESTREAM_SALSA20,
		...
		case CipherSuite.TLS_RSA_PSK_WITH_ESTREAM_SALSA20_UMAC96:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.ESTREAM_SALSA20, MACAlgorithm.umac96);
		...
		case CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA384:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.NULL, MACAlgorithm.hmac_sha384);
		...
		case CipherSuite.TLS_RSA_PSK_WITH_SALSA20_SHA1:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.SALSA20, MACAlgorithm.hmac_sha1);
		...
		case CipherSuite.TLS_RSA_PSK_WITH_SALSA20_UMAC96:
			return cipherFactory.createCipher(context,
					EncryptionAlgorithm.SALSA20, MACAlgorithm.umac96);
	...
	protected TlsKeyExchange createPSKKeyExchange(int keyExchange) {
		return new TlsPSKKeyExchange(keyExchange, supportedSignatureAlgorithms,
				pskIdentity, null, namedCurves, clientECPointFormats,
