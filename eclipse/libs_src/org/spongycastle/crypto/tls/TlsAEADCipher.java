...
public class TlsAEADCipher implements TlsCipher {
	...
	public TlsAEADCipher(TlsContext context, AEADBlockCipher clientWriteCipher,
		...
		// NOTE: Valid for RFC 5288/6655 ciphers but may need review for other
		// AEAD ciphers
	...
	public byte[] encodePlaintext(long seqNo, short type, byte[] plaintext,
		...
		AEADParameters parameters = new AEADParameters(null, 8 * macSize,
				nonce, additionalData);
	...
	public byte[] decodeCiphertext(long seqNo, short type, byte[] ciphertext,
		...
		try {
			...
			outputPos += decryptCipher.processBytes(ciphertext,
					ciphertextOffset, ciphertextLength, output, outputPos);
