...
public final class SessionParameters {
	public static final class Builder {
		...
		public SessionParameters build() {
			...
			return new SessionParameters(cipherSuite, compressionAlgorithm,
					masterSecret, peerCertificate, encodedServerExtensions);
		}
		...
		private void validate(boolean condition, String parameter) {
			if (!condition) {
				throw new IllegalStateException("Required session parameter '"
	...
	private SessionParameters(int cipherSuite, short compressionAlgorithm,
			byte[] masterSecret, Certificate peerCertificate,
