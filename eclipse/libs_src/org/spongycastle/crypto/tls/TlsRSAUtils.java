...
public class TlsRSAUtils {
	...
	public static byte[] safeDecryptPreMasterSecret(TlsContext context,
		...
		try {
			 ...
			 * the handshake with a randomly generated premaster secret.
			 */
		}
		...
		if (versionNumberCheckDisabled
			 ...
			 * ClientHello.client_version produces an invalid master_secret if
			 * the client has sent the wrong version in the original
			 * pre_master_secret.
			 */
