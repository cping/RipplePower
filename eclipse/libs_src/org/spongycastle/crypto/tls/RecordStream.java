...
class RecordStream {
	...
	protected byte[] decodeAndVerify(short type, InputStream input, int len)
		...
		checkLength(decoded.length, compressedLimit,
		 ...
		 */
		checkLength(decoded.length, plaintextLimit,
	...
	protected void writeRecord(short type, byte[] plaintext,
		 ...
		 */
		checkLength(plaintextLength, plaintextLimit,
		 ...
		 */
		checkLength(ciphertext.length, ciphertextLimit,
				AlertDescription.internal_error);
