...
class DeferredHash implements TlsHandshakeHash {
	...
	public TlsHandshakeHash notifyPRFDetermined() {
		...
		this.prfHashAlgorithm = Shorts.valueOf(TlsUtils
				.getHashAlgorithmForPRFAlgorithm(prfAlgorithm));
	...
	public void trackHashAlgorithm(short hashAlgorithm) {
		if (buf == null) {
			throw new IllegalStateException(
					"Too late to track more hash algorithms");
		}
	...
	public TlsHandshakeHash stopTracking() {
		Digest prfHash = TlsUtils.cloneHash(prfHashAlgorithm.shortValue(),
				(Digest) hashes.get(prfHashAlgorithm));
		if (buf != null) {
	...
	public Digest forkPRFHash() {
		...
		return TlsUtils.cloneHash(prfHashAlgorithm.shortValue(),
				(Digest) hashes.get(prfHashAlgorithm));
	}
	...
	public byte[] getFinalHash(short hashAlgorithm) {
		...
		if (d == null) {
			throw new IllegalStateException("HashAlgorithm " + hashAlgorithm
