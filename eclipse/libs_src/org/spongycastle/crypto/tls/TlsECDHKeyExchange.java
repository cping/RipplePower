...
public class TlsECDHKeyExchange extends AbstractTlsKeyExchange {
	...
	public void generateClientKeyExchange(OutputStream output)
		...
		if (agreementCredentials == null) {
			this.ecAgreePrivateKey = TlsECCUtils
					.generateEphemeralClientKeyExchange(
							context.getSecureRandom(), serverECPointFormats,
	...
	public void processClientKeyExchange(InputStream input) throws IOException {
		...
		ECDomainParameters curve_params = this.ecAgreePrivateKey
				.getParameters();

		this.ecAgreePublicKey = TlsECCUtils.validateECPublicKey(TlsECCUtils
				.deserializeECPublicKey(serverECPointFormats, curve_params,
						point));
	}
	...
	public byte[] generatePremasterSecret() throws IOException {
		...
		if (ecAgreePrivateKey != null) {
			return TlsECCUtils.calculateECDHBasicAgreement(ecAgreePublicKey,
					ecAgreePrivateKey);
		}
