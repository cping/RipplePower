...
public class GOST3411Digest implements ExtendedDigest, Memoable {
	...
	private byte[] H = new byte[32], L = new byte[32], M = new byte[32],
			Sum = new byte[32];
	...
	private void finish() {
		Pack.longToLittleEndian(byteCount * 8, L, 0); // get length into L
														// (byteCount * 8 =
														// bitCount)
	 ...
	 */
	private static final byte[] C2 = { 0x00, (byte) 0xFF, 0x00, (byte) 0xFF,
			0x00, (byte) 0xFF, 0x00, (byte) 0xFF, (byte) 0xFF, 0x00,
			(byte) 0xFF, 0x00, (byte) 0xFF, 0x00, (byte) 0xFF, 0x00, 0x00,
			(byte) 0xFF, (byte) 0xFF, 0x00, (byte) 0xFF, 0x00, 0x00,
			(byte) 0xFF, (byte) 0xFF, 0x00, 0x00, 0x00, (byte) 0xFF,
