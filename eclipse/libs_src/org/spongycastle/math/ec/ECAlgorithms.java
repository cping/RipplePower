...
public class ECAlgorithms {
	...
	static ECPoint implShamirsTrick(ECPoint P, BigInteger k, ECPoint Q,
			BigInteger l) {
		...
		ECPoint[] table = new ECPoint[] { points[3].negate(),
				points[2].negate(), points[1].negate(), points[0].negate(),
				infinity, points[0], points[1], points[2], points[3] };
