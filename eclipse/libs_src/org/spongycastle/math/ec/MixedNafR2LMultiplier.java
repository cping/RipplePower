...
public class MixedNafR2LMultiplier extends AbstractECMultiplier {
	...
	/**
	 * By default, addition will be done in Jacobian coordinates, and doubling
	 * will be done in Modified Jacobian coordinates (independent of the
	 * original coordinate system of each point).
	 */
	...
	protected ECCurve configureCurve(ECCurve c, int coord) {
		...
		if (!c.supportsCoordinateSystem(coord)) {
			throw new IllegalArgumentException("Coordinate system " + coord
