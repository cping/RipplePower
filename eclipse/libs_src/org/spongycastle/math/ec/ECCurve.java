...
public abstract class ECCurve {
	...
	public static int[] getAllCoordinateSystems() {
		return new int[] { COORD_AFFINE, COORD_HOMOGENEOUS, COORD_JACOBIAN,
				COORD_JACOBIAN_CHUDNOVSKY, COORD_JACOBIAN_MODIFIED,
	 ...
	 * <code>ECMultiplier</code>s to save the precomputation for this
	...
	public ECPoint importPoint(ECPoint p) {
		...
		return createPoint(p.getXCoord().toBigInteger(), p.getYCoord()
				.toBigInteger(), p.withCompression);
	}
	...
	public ECPoint decodePoint(byte[] encoded) {
		...
		case 0x03: // compressed
		{
			...
			BigInteger X = BigIntegers.fromUnsignedByteArray(encoded, 1,
					expectedLength);
		...
		case 0x07: // hybrid
		{
			...
			BigInteger Y = BigIntegers.fromUnsignedByteArray(encoded,
					1 + expectedLength, expectedLength);
	...
	public static class Fp extends ECCurve {
			...
			if (this != p.getCurve()
				...
				case COORD_JACOBIAN_MODIFIED:
					return new ECPoint.Fp(this,
							...
							new ECFieldElement[] { fromBigInteger(p.zs[0]
									.toBigInteger()) }, p.withCompression);
				default:
					break;
				}
		...
		public boolean equals(Object anObject) {
			...
			return this.q.equals(other.q) && a.equals(other.a)
					&& b.equals(other.b);
		}
	...
	public static class F2m extends ECCurve {
		 ...
		 *            .
		 */
		public F2m(int m, int k, BigInteger a, BigInteger b, BigInteger n,
				BigInteger h) {
		...
		protected F2m(int m, int k1, int k2, int k3, ECFieldElement a,
				ECFieldElement b, BigInteger n, BigInteger h) {
			this.m = m;
			this.k1 = k1;
			this.k2 = k2;
			this.k3 = k3;
		...
		public boolean isKoblitz() {
			return n != null && h != null && a.bitLength() <= 1
					&& b.bitLength() == 1;
		}
