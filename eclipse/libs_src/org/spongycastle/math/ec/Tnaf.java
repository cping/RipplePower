...
class Tnaf {
	...
	/**
	 * Multiplies a {@link org.spongycastle.math.ec.ECPoint.F2m ECPoint.F2m} by
	 * a <code>BigInteger</code> using the reduced <code>&tau;</code>-adic NAF
	 * (RTNAF) method.
	 * 
	 * @param p
	...
	/**
	 * Multiplies a {@link org.spongycastle.math.ec.ECPoint.F2m ECPoint.F2m} by
	 * an element <code>&lambda;</code> of <code><b>Z</b>[&tau;]</code> using
