...
public class ServiceType extends ASN1Object {
	...
	/**
	 * Identifier of VPKC service (Verify Public Key Certificates (also referred
	 * to as CPKC)).
	 */
	...
	public String toString() {
		...
		return ""
				+ num
				+ (num == CPD.getValue().intValue() ? "(CPD)" : num == VSD
						.getValue().intValue() ? "(VSD)" : num == VPKC
						.getValue().intValue() ? "(VPKC)" : num == CCPD
