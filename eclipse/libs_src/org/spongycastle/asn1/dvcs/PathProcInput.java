...
public class PathProcInput extends ASN1Object {
	...
	public PathProcInput(PolicyInformation[] acceptablePolicySet,
			boolean inhibitPolicyMapping, boolean explicitPolicyReqd,
	...
	public static PathProcInput getInstance(Object obj) {
		if (obj instanceof PathProcInput) {
			...
			ASN1Sequence policies = ASN1Sequence
	...
	public ASN1Primitive toASN1Primitive() {
		...
		if (explicitPolicyReqd) {
			v.add(new DERTaggedObject(false, 0, new ASN1Boolean(
					explicitPolicyReqd)));
		}
		if (inhibitAnyPolicy) {
			v.add(new DERTaggedObject(false, 1, new ASN1Boolean(
					inhibitAnyPolicy)));
		}
