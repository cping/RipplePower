	...
	public static DVCSResponse getInstance(Object obj) {
		if (obj == null || obj instanceof DVCSResponse) {
			...
			if (obj instanceof ASN1TaggedObject) {
				...
				DVCSErrorNotice dvErrorNote = DVCSErrorNotice.getInstance(t,
						false);
		...
		throw new IllegalArgumentException(
				"Couldn't convert from object to DVCSResponse: "
						+ obj.getClass().getName());
	}

	public static DVCSResponse getInstance(ASN1TaggedObject obj,
			boolean explicit) {
