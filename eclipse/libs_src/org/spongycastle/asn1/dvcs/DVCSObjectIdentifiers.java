...
public interface DVCSObjectIdentifiers {
	...
	static final ASN1ObjectIdentifier id_smime = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.9.16");

	/**
	 * Authority Information Access for DVCS; id-ad-dcvs; OID:
	 * 1.3.6.1.5.5.7.48.4
	 */
	...
	static final ASN1ObjectIdentifier id_ct_DVCSRequestData = id_smime
			.branch("1.7");
	/**
	 * SMIME eContentType id-ct-DVCSResponseData; OID: 1.2.840.113549.1.9.16.1.8
	 */
	static final ASN1ObjectIdentifier id_ct_DVCSResponseData = id_smime
			.branch("1.8");
