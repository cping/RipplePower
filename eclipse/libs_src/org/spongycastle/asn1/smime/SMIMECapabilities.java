...
public class SMIMECapabilities extends ASN1Object {
	 ...
	 */
	public static final ASN1ObjectIdentifier dES_CBC = new ASN1ObjectIdentifier(
			"1.3.14.3.2.7");
	...
	public static SMIMECapabilities getInstance(Object o) {
		...
		if (o instanceof Attribute) {
			return new SMIMECapabilities(
					(ASN1Sequence) (((Attribute) o).getAttrValues()
							.getObjectAt(0)));
		}
	...
	public Vector getCapabilities(ASN1ObjectIdentifier capability) {
		...
		if (capability == null) {
			while (e.hasMoreElements()) {
				SMIMECapability cap = SMIMECapability.getInstance(e
						.nextElement());
