...
public class SignerInfo extends ASN1Object {
	 ...
	 */
	public SignerInfo(SignerIdentifier sid, AlgorithmIdentifier digAlgorithm,
			ASN1Set authenticatedAttributes,
			AlgorithmIdentifier digEncryptionAlgorithm,
			ASN1OctetString encryptedDigest, ASN1Set unauthenticatedAttributes) {
		if (sid.isTagged()) {
	...
	public SignerInfo(SignerIdentifier sid, AlgorithmIdentifier digAlgorithm,
		...
		this.authenticatedAttributes = ASN1Set
				.getInstance(authenticatedAttributes);
		this.digEncryptionAlgorithm = digEncryptionAlgorithm;
		this.encryptedDigest = encryptedDigest;
		this.unauthenticatedAttributes = ASN1Set
				.getInstance(unauthenticatedAttributes);
	}
	...
	public SignerInfo(ASN1Sequence seq) {
		...
		if (obj instanceof ASN1TaggedObject) {
			authenticatedAttributes = ASN1Set.getInstance(
		...
		if (e.hasMoreElements()) {
			unauthenticatedAttributes = ASN1Set.getInstance(
					(ASN1TaggedObject) e.nextElement(), false);
		} else {
