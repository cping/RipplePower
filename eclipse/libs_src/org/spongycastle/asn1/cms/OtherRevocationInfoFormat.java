...
public class OtherRevocationInfoFormat extends ASN1Object {
	...
	public OtherRevocationInfoFormat(ASN1ObjectIdentifier otherRevInfoFormat,
	...
	private OtherRevocationInfoFormat(ASN1Sequence seq) {
		otherRevInfoFormat = ASN1ObjectIdentifier.getInstance(seq
				.getObjectAt(0));
	 ...
	 *                converted.
	 */
	public static OtherRevocationInfoFormat getInstance(ASN1TaggedObject obj,
			boolean explicit) {
	 ...
	 * ASN1Sequence} input formats with OtherRevocationInfoFormat structure
	 * inside
	 * </ul>
	 * 
	 * @param obj
