...
public class OriginatorIdentifierOrKey extends ASN1Object implements ASN1Choice {
	 ...
	 * ASN1TaggedObject} input formats with IssuerAndSerialNumber structure
	 * inside
	 * </ul>
	 * 
	 * @param o
	...
	public SubjectKeyIdentifier getSubjectKeyIdentifier() {
		if (id instanceof ASN1TaggedObject
				&& ((ASN1TaggedObject) id).getTagNo() == 0) {
			return SubjectKeyIdentifier.getInstance((ASN1TaggedObject) id,
					false);
		}
	...
	public OriginatorPublicKey getOriginatorKey() {
		if (id instanceof ASN1TaggedObject
				&& ((ASN1TaggedObject) id).getTagNo() == 1) {
			return OriginatorPublicKey
					.getInstance((ASN1TaggedObject) id, false);
		}
