...
public class TimeStampedData extends ASN1Object {
	...
	public TimeStampedData(DERIA5String dataUri, MetaData metaData,
			ASN1OctetString content, Evidence temporalEvidence) {
	...
	private TimeStampedData(ASN1Sequence seq) {
		...
		if (seq.getObjectAt(index) instanceof MetaData
				|| seq.getObjectAt(index) instanceof ASN1Sequence) {
