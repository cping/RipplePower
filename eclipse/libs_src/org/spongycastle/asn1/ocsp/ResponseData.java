...
public class ResponseData extends ASN1Object {
	...
	public ResponseData(ASN1Integer version, ResponderID responderID,
			ASN1GeneralizedTime producedAt, ASN1Sequence responses,
	 ...
	 */
	public ResponseData(ResponderID responderID, DERGeneralizedTime producedAt,
			ASN1Sequence responses, X509Extensions responseExtensions) {
		this(V1, responderID, ASN1GeneralizedTime.getInstance(producedAt),
				responses, Extensions.getInstance(responseExtensions));
	}
	...
	private ResponseData(ASN1Sequence seq) {
		...
		this.producedAt = ASN1GeneralizedTime.getInstance(seq
				.getObjectAt(index++));
