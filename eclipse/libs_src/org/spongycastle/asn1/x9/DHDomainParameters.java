...
public class DHDomainParameters extends ASN1Object {
	...
	public DHDomainParameters(ASN1Integer p, ASN1Integer g, ASN1Integer q,
			ASN1Integer j, DHValidationParms validationParms) {
		if (p == null) {
	...
	private DHDomainParameters(ASN1Sequence seq) {
		...
		if (next != null) {
			this.validationParms = DHValidationParms.getInstance(next
					.toASN1Primitive());
		}
	}
