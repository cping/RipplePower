...
public class X509Name extends ASN1Object {
	...
	public static X509Name getInstance(Object obj) {
		if (obj == null || obj instanceof X509Name) {
			...
			return new X509Name(ASN1Sequence.getInstance(((X500Name) obj)
					.toASN1Primitive()));
		} else if (obj != null) {
	...
	public X509Name(ASN1Sequence seq) {
		...
		while (e.hasMoreElements()) {
			ASN1Set set = ASN1Set.getInstance(((ASN1Encodable) e.nextElement())
					.toASN1Primitive());
			...
			for (int i = 0; i < set.size(); i++) {
				...
				ordering.addElement(ASN1ObjectIdentifier.getInstance(s
						.getObjectAt(0)));
	...
	public X509Name(Vector ordering, Hashtable attributes,
		...
		for (int i = 0; i != this.ordering.size(); i++) {
			ASN1ObjectIdentifier oid = (ASN1ObjectIdentifier) this.ordering
					.elementAt(i);
	...
	private String unescape(String elt) {
		...
		// if it's an escaped hash string and not an actual encoding in string
		// form
	...
	public ASN1Primitive toASN1Primitive() {
		if (seq == null) {
			...
			for (int i = 0; i != ordering.size(); i++) {
				...
				ASN1ObjectIdentifier oid = (ASN1ObjectIdentifier) ordering
						.elementAt(i);
	...
	public boolean equals(Object obj, boolean inOrder) {
		...
		for (int i = 0; i < orderingSize; i++) {
			ASN1ObjectIdentifier oid = (ASN1ObjectIdentifier) ordering
					.elementAt(i);
			ASN1ObjectIdentifier oOid = (ASN1ObjectIdentifier) other.ordering
					.elementAt(i);
