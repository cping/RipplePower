...
public class IssuingDistributionPoint extends ASN1Object {
	...
	public IssuingDistributionPoint(DistributionPointName distributionPoint,
			...
			ReasonFlags onlySomeReasons, boolean indirectCRL,
	...
	private IssuingDistributionPoint(ASN1Sequence seq) {
		...
		for (int i = 0; i != seq.size(); i++) {
			ASN1TaggedObject o = ASN1TaggedObject.getInstance(seq
					.getObjectAt(i));
			...
			case 0:
				...
				break;
			case 1:
				onlyContainsUserCerts = ASN1Boolean.getInstance(o, false)
						.isTrue();
				break;
			case 2:
				onlyContainsCACerts = ASN1Boolean.getInstance(o, false)
						.isTrue();
				break;
			case 3:
				onlySomeReasons = new ReasonFlags(ReasonFlags.getInstance(o,
						false));
				break;
			case 4:
				...
				break;
			case 5:
				onlyContainsAttributeCerts = ASN1Boolean.getInstance(o, false)
						.isTrue();
				break;
			default:
	...
	public String toString() {
		...
		if (distributionPoint != null) {
			appendObject(buf, sep, "distributionPoint",
					distributionPoint.toString());
		}
		if (onlyContainsUserCerts) {
			appendObject(buf, sep, "onlyContainsUserCerts",
					booleanToString(onlyContainsUserCerts));
		}
		if (onlyContainsCACerts) {
			appendObject(buf, sep, "onlyContainsCACerts",
					booleanToString(onlyContainsCACerts));
		}
		if (onlySomeReasons != null) {
			appendObject(buf, sep, "onlySomeReasons",
					onlySomeReasons.toString());
		}
		if (onlyContainsAttributeCerts) {
	...
	private void appendObject(StringBuffer buf, String sep, String name,
			String value) {
		String indent = "    ";
