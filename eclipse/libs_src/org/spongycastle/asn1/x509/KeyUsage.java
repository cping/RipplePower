...
public class KeyUsage extends ASN1Object {
	...
	public static KeyUsage getInstance(Object obj) // needs to be DERBitString
													// for other VMs
	{
	...
	public static KeyUsage fromExtensions(Extensions extensions) {
		return KeyUsage.getInstance(extensions
	 ...
	 * 
	 * @param usage
	 *            - the bitwise OR of the Key Usage flags giving the allowed
