...
public class ExtendedKeyUsage extends ASN1Object {
	...
	/**
	 * Retrieve an ExtendedKeyUsage for a passed in Extensions object, if
	 * present.
	 * 
	 * @param extensions
	...
	public static ExtendedKeyUsage fromExtensions(Extensions extensions) {
		return ExtendedKeyUsage.getInstance(extensions
				.getExtensionParsedValue(Extension.extendedKeyUsage));
	}
