...
public class X509Extensions extends ASN1Object {
	...
	public static X509Extensions getInstance(Object obj) {
		...
		if (obj instanceof Extensions) {
			return new X509Extensions(
					(ASN1Sequence) ((Extensions) obj).toASN1Primitive());
		}
	...
	public X509Extensions(ASN1Sequence seq) {
		...
		while (e.hasMoreElements()) {
			...
			if (s.size() == 3) {
				extensions.put(
						s.getObjectAt(0),
						new X509Extension(DERBoolean.getInstance(s
								.getObjectAt(1)), ASN1OctetString.getInstance(s
								.getObjectAt(2))));
			} else if (s.size() == 2) {
	...
	public X509Extensions(Vector ordering, Hashtable extensions) {
		...
		while (e.hasMoreElements()) {
			this.ordering.addElement(ASN1ObjectIdentifier.getInstance(e
					.nextElement()));
		}
		...
		while (e.hasMoreElements()) {
			ASN1ObjectIdentifier oid = ASN1ObjectIdentifier.getInstance(e
					.nextElement());
