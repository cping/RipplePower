...
public class DERExternal extends ASN1Primitive {
	...
	public DERExternal(ASN1ObjectIdentifier directReference,
			ASN1Integer indirectReference, ASN1Primitive dataValueDescriptor,
			DERTaggedObject externalData) {
		this(directReference, indirectReference, dataValueDescriptor,
				externalData.getTagNo(), externalData.toASN1Primitive());
	}
	 ...
	 * 
	 * @see
	 * org.spongycastle.asn1.ASN1Primitive#asn1Equals(org.spongycastle.asn1.
	 * ASN1Primitive)
	 */
