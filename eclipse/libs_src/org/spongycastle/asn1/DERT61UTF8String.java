...
public class DERT61UTF8String extends ASN1Primitive implements ASN1String {
	...
	/**
	 * return a T61 string from the passed in object. UTF-8 Encoding is assumed
	 * in this case.
	 * 
	...
	public static DERT61UTF8String getInstance(Object obj) {
		...
		if (obj instanceof byte[]) {
			try {
				return new DERT61UTF8String(
						((DERT61String) fromByteArray((byte[]) obj))
								.getOctets());
			} catch (Exception e) {
	...
	/**
	 * return an T61 String from a tagged object. UTF-8 encoding is assumed in
	 * this case.
	 * 
	 * @param obj
	...
	public static DERT61UTF8String getInstance(ASN1TaggedObject obj,
		...
		if (explicit || o instanceof DERT61String
				|| o instanceof DERT61UTF8String) {
			return getInstance(o);
		} else {
			return new DERT61UTF8String(ASN1OctetString.getInstance(o)
					.getOctets());
		}
	}
