...
public class SignerAttribute extends ASN1Object {
	...
	private SignerAttribute(ASN1Sequence seq) {
		...
		for (Enumeration e = seq.getObjects(); e.hasMoreElements();) {
			ASN1TaggedObject taggedObject = ASN1TaggedObject.getInstance(e
					.nextElement());

			if (taggedObject.getTagNo() == 0) {
				ASN1Sequence attrs = ASN1Sequence.getInstance(taggedObject,
						true);
				...
				values[index] = AttributeCertificate.getInstance(ASN1Sequence
