...
public interface PKCSObjectIdentifiers {
	...
	static final ASN1ObjectIdentifier pkcs_1 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.1");
	...
	static final ASN1ObjectIdentifier sha1WithRSAEncryption = pkcs_1
			.branch("5");
	/** PKCS#1: 1.2.840.113549.1.1.6 */
	static final ASN1ObjectIdentifier srsaOAEPEncryptionSET = pkcs_1
			.branch("6");
	...
	static final ASN1ObjectIdentifier sha256WithRSAEncryption = pkcs_1
			.branch("11");
	/** PKCS#1: 1.2.840.113549.1.1.12 */
	static final ASN1ObjectIdentifier sha384WithRSAEncryption = pkcs_1
			.branch("12");
	/** PKCS#1: 1.2.840.113549.1.1.13 */
	static final ASN1ObjectIdentifier sha512WithRSAEncryption = pkcs_1
			.branch("13");
	/** PKCS#1: 1.2.840.113549.1.1.14 */
	static final ASN1ObjectIdentifier sha224WithRSAEncryption = pkcs_1
			.branch("14");
	...
	static final ASN1ObjectIdentifier pkcs_3 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.3");
	...
	static final ASN1ObjectIdentifier pkcs_5 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.5");
	...
	static final ASN1ObjectIdentifier pbeWithSHA1AndDES_CBC = pkcs_5
			.branch("10");
	/** PKCS#5: 1.2.840.113549.1.5.11 */
	static final ASN1ObjectIdentifier pbeWithSHA1AndRC2_CBC = pkcs_5
			.branch("11");
	...
	//
	/** 1.2.840.113549.3 */
	static final ASN1ObjectIdentifier encryptionAlgorithm = new ASN1ObjectIdentifier(
			"1.2.840.113549.3");

	/** 1.2.840.113549.3.7 */
	static final ASN1ObjectIdentifier des_EDE3_CBC = encryptionAlgorithm
			.branch("7");
	/** 1.2.840.113549.3.2 */
	...
	//
	/** 1.2.840.113549.2 */
	static final ASN1ObjectIdentifier digestAlgorithm = new ASN1ObjectIdentifier(
			"1.2.840.113549.2");
	//
	...
	/** 1.2.840.113549.2.7 */
	static final ASN1ObjectIdentifier id_hmacWithSHA1 = digestAlgorithm
			.branch("7");
	/** 1.2.840.113549.2.8 */
	static final ASN1ObjectIdentifier id_hmacWithSHA224 = digestAlgorithm
			.branch("8");
	/** 1.2.840.113549.2.9 */
	static final ASN1ObjectIdentifier id_hmacWithSHA256 = digestAlgorithm
			.branch("9");
	/** 1.2.840.113549.2.10 */
	static final ASN1ObjectIdentifier id_hmacWithSHA384 = digestAlgorithm
			.branch("10");
	/** 1.2.840.113549.2.11 */
	static final ASN1ObjectIdentifier id_hmacWithSHA512 = digestAlgorithm
			.branch("11");
	...
	static final ASN1ObjectIdentifier pkcs_7 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7");
	/** PKCS#7: 1.2.840.113549.1.7.1 */
	static final ASN1ObjectIdentifier data = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7.1");
	/** PKCS#7: 1.2.840.113549.1.7.2 */
	static final ASN1ObjectIdentifier signedData = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7.2");
	/** PKCS#7: 1.2.840.113549.1.7.3 */
	static final ASN1ObjectIdentifier envelopedData = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7.3");
	/** PKCS#7: 1.2.840.113549.1.7.4 */
	static final ASN1ObjectIdentifier signedAndEnvelopedData = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7.4");
	/** PKCS#7: 1.2.840.113549.1.7.5 */
	static final ASN1ObjectIdentifier digestedData = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.7.5");
	/** PKCS#7: 1.2.840.113549.1.7.76 */
	static final ASN1ObjectIdentifier encryptedData = new ASN1ObjectIdentifier(
	...
	static final ASN1ObjectIdentifier pkcs_9 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.9");

	/** PKCS#9: 1.2.840.113549.1.9.1 */
	static final ASN1ObjectIdentifier pkcs_9_at_emailAddress = pkcs_9
			.branch("1");
	/** PKCS#9: 1.2.840.113549.1.9.2 */
	static final ASN1ObjectIdentifier pkcs_9_at_unstructuredName = pkcs_9
			.branch("2");
	/** PKCS#9: 1.2.840.113549.1.9.3 */
	static final ASN1ObjectIdentifier pkcs_9_at_contentType = pkcs_9
			.branch("3");
	/** PKCS#9: 1.2.840.113549.1.9.4 */
	static final ASN1ObjectIdentifier pkcs_9_at_messageDigest = pkcs_9
			.branch("4");
	/** PKCS#9: 1.2.840.113549.1.9.5 */
	static final ASN1ObjectIdentifier pkcs_9_at_signingTime = pkcs_9
			.branch("5");
	/** PKCS#9: 1.2.840.113549.1.9.6 */
	static final ASN1ObjectIdentifier pkcs_9_at_counterSignature = pkcs_9
			.branch("6");
	/** PKCS#9: 1.2.840.113549.1.9.7 */
	static final ASN1ObjectIdentifier pkcs_9_at_challengePassword = pkcs_9
			.branch("7");
	/** PKCS#9: 1.2.840.113549.1.9.8 */
	static final ASN1ObjectIdentifier pkcs_9_at_unstructuredAddress = pkcs_9
			.branch("8");
	/** PKCS#9: 1.2.840.113549.1.9.9 */
	static final ASN1ObjectIdentifier pkcs_9_at_extendedCertificateAttributes = pkcs_9
			.branch("9");

	/** PKCS#9: 1.2.840.113549.1.9.13 */
	static final ASN1ObjectIdentifier pkcs_9_at_signingDescription = pkcs_9
			.branch("13");
	/** PKCS#9: 1.2.840.113549.1.9.14 */
	static final ASN1ObjectIdentifier pkcs_9_at_extensionRequest = pkcs_9
			.branch("14");
	/** PKCS#9: 1.2.840.113549.1.9.15 */
	static final ASN1ObjectIdentifier pkcs_9_at_smimeCapabilities = pkcs_9
			.branch("15");
	/** PKCS#9: 1.2.840.113549.1.9.16 */
	static final ASN1ObjectIdentifier id_smime = pkcs_9.branch("16");

	/** PKCS#9: 1.2.840.113549.1.9.20 */
	static final ASN1ObjectIdentifier pkcs_9_at_friendlyName = pkcs_9
			.branch("20");
	/** PKCS#9: 1.2.840.113549.1.9.21 */
	static final ASN1ObjectIdentifier pkcs_9_at_localKeyId = pkcs_9
			.branch("21");
	...
	static final ASN1ObjectIdentifier sMIMECapabilitiesVersions = pkcs_9
			.branch("15.3");
	...
	static final ASN1ObjectIdentifier id_ct = new ASN1ObjectIdentifier(
	...
	static final ASN1ObjectIdentifier id_ct_authEnvelopedData = id_ct
			.branch("23");
	/** PKCS#9: 1.2.840.113549.1.9.16.1.31 -- smime ct timestampedData */
	static final ASN1ObjectIdentifier id_ct_timestampedData = id_ct
			.branch("31");
	...
	static final ASN1ObjectIdentifier id_cti = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.9.16.6");

	/** PKCS#9: 1.2.840.113549.1.9.16.6.1 -- smime cti proofOfOrigin */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfOrigin = id_cti
			.branch("1");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.2 -- smime cti proofOfReceipt */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfReceipt = id_cti
			.branch("2");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.3 -- smime cti proofOfDelivery */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfDelivery = id_cti
			.branch("3");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.4 -- smime cti proofOfSender */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfSender = id_cti
			.branch("4");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.5 -- smime cti proofOfApproval */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfApproval = id_cti
			.branch("5");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.6 -- smime cti proofOfCreation */
	static final ASN1ObjectIdentifier id_cti_ets_proofOfCreation = id_cti
			.branch("6");
	...
	static final ASN1ObjectIdentifier id_aa = new ASN1ObjectIdentifier(
	...
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.4 - See <a
	 * href="http://tools.ietf.org/html/rfc2634">RFC 2634</a>
	 */
	static final ASN1ObjectIdentifier id_aa_contentHint = id_aa.branch("4"); // See
																				// RFC
																				// 2634
	...
	static final ASN1ObjectIdentifier id_aa_contentReference = id_aa
			.branch("10");
	/*
	...
	static final ASN1ObjectIdentifier id_aa_signingCertificate = id_aa
			.branch("12");
	/** PKCS#9: 1.2.840.113549.1.9.16.6.2.47 */
	static final ASN1ObjectIdentifier id_aa_signingCertificateV2 = id_aa
			.branch("47");

	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.7 - See <a
	 * href="http://tools.ietf.org/html/rfc2634">RFC 2634</a>
	 */
	static final ASN1ObjectIdentifier id_aa_contentIdentifier = id_aa
			.branch("7"); // See RFC 2634

	/*
	 * RFC 3126
	 */
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.14 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_signatureTimeStampToken = id_aa
			.branch("14");

	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.15 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_sigPolicyId = id_aa
			.branch("15");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.16 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_commitmentType = id_aa
			.branch("16");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.17 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_signerLocation = id_aa
			.branch("17");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.18 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_signerAttr = id_aa.branch("18");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.19 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_otherSigCert = id_aa
			.branch("19");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.20 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_contentTimestamp = id_aa
			.branch("20");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.21 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_certificateRefs = id_aa
			.branch("21");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.22 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_revocationRefs = id_aa
			.branch("22");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.23 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_certValues = id_aa.branch("23");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.24 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_revocationValues = id_aa
			.branch("24");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.25 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_escTimeStamp = id_aa
			.branch("25");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.26 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_certCRLTimestamp = id_aa
			.branch("26");
	/**
	 * PKCS#9: 1.2.840.113549.1.9.16.6.2.27 - <a
	 * href="http://tools.ietf.org/html/rfc3126">RFC 3126</a>
	 */
	static final ASN1ObjectIdentifier id_aa_ets_archiveTimestamp = id_aa
			.branch("27");
	...
	static final ASN1ObjectIdentifier id_spq_ets_uri = new ASN1ObjectIdentifier(
			id_spq + ".1");
	/** SMIME SPQ UNOTICE: 1.2.840.113549.1.9.16.5.2 */
	static final ASN1ObjectIdentifier id_spq_ets_unotice = new ASN1ObjectIdentifier(
			id_spq + ".2");
	...
	static final ASN1ObjectIdentifier pkcs_12 = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.12");
	...
	static final ASN1ObjectIdentifier pkcs8ShroudedKeyBag = bagtypes
			.branch("2");
	...
	static final ASN1ObjectIdentifier pbeWithSHAAnd128BitRC4 = pkcs_12PbeIds
			.branch("1");
	/** PKCS#12: 1.2.840.113549.1.12.1.2 */
	static final ASN1ObjectIdentifier pbeWithSHAAnd40BitRC4 = pkcs_12PbeIds
			.branch("2");
	/** PKCS#12: 1.2.840.113549.1.12.1.3 */
	static final ASN1ObjectIdentifier pbeWithSHAAnd3_KeyTripleDES_CBC = pkcs_12PbeIds
			.branch("3");
	/** PKCS#12: 1.2.840.113549.1.12.1.4 */
	static final ASN1ObjectIdentifier pbeWithSHAAnd2_KeyTripleDES_CBC = pkcs_12PbeIds
			.branch("4");
	/** PKCS#12: 1.2.840.113549.1.12.1.5 */
	static final ASN1ObjectIdentifier pbeWithSHAAnd128BitRC2_CBC = pkcs_12PbeIds
			.branch("5");
	/** PKCS#12: 1.2.840.113549.1.12.1.6 */
	static final ASN1ObjectIdentifier pbeWithSHAAnd40BitRC2_CBC = pkcs_12PbeIds
			.branch("6");
	...
	static final ASN1ObjectIdentifier id_alg_CMS3DESwrap = new ASN1ObjectIdentifier(
			"1.2.840.113549.1.9.16.3.6");
	/** PKCS#9: 1.2.840.113549.1.9.16.3.7 */
	static final ASN1ObjectIdentifier id_alg_CMSRC2wrap = new ASN1ObjectIdentifier(
