...
public class RFC4519Style implements X500NameStyle {
	...
	static {
		...
		DefaultSymbols.put(physicalDeliveryOfficeName,
		...
		DefaultSymbols.put(teletexTerminalIdentifier,
		...
		DefaultLookUp.put("physicaldeliveryofficename",
				physicalDeliveryOfficeName);
		...
		DefaultLookUp.put("teletexterminalidentifier",
				teletexTerminalIdentifier);
	...
	public ASN1Encodable stringToValue(ASN1ObjectIdentifier oid, String value) {
		if (value.length() != 0 && value.charAt(0) == '#') {
			...
			} else if (oid.equals(c) || oid.equals(serialNumber)
					|| oid.equals(dnQualifier) || oid.equals(telephoneNumber)) {
