...
public class LongPolynomial5 {
	...
	/**
	 * Multiplies the polynomial with a <code>TernaryPolynomial</code>, taking
	 * the indices mod N and the values mod 2048.
	 */
	public LongPolynomial5 mult(TernaryPolynomial poly2) {
		long[][] prod = new long[5][coeffs.length + (poly2.size() + 4) / 5 - 1]; // intermediate
																					// results,
																					// the
																					// subarrays
																					// are
