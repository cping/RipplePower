...
public class LongPolynomial2 {
	private long[] coeffs; // each representing two coefficients in the original
							// IntegerPolynomial
	 ...
	 * 
	 * @param p
	 *            the original polynomial. Coefficients must be between 0 and
	 *            2047.
	 */
	...
	private LongPolynomial2 multRecursive(LongPolynomial2 poly2) {
		...
		if (n <= 32) {
			...
			LongPolynomial2 a2 = new LongPolynomial2(Arrays.copyOfRange(a, n1,
					n));
			LongPolynomial2 b1 = new LongPolynomial2(Arrays.copyOf(b, n1));
			LongPolynomial2 b2 = new LongPolynomial2(Arrays.copyOfRange(b, n1,
					n));
	...
	/**
	 * Subtracts another polynomial which must have the same number of
	 * coefficients, and applies an AND mask to the upper and lower halves of
	 * each coefficients.
	 * 
	 * @param b
	 *            another polynomial
