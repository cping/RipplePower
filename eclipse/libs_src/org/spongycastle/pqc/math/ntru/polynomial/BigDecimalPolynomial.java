...
public class BigDecimalPolynomial {
	...
	private BigDecimalPolynomial multRecursive(BigDecimalPolynomial poly2) {
		...
		if (n <= 1) {
			...
			BigDecimalPolynomial a2 = new BigDecimalPolynomial(copyOfRange(a,
					n1, n));
			BigDecimalPolynomial b1 = new BigDecimalPolynomial(copyOf(b, n1));
			BigDecimalPolynomial b2 = new BigDecimalPolynomial(copyOfRange(b,
					n1, n));
	...
	public BigIntPolynomial round() {
		...
		for (int i = 0; i < N; i++) {
			p.coeffs[i] = coeffs[i].setScale(0, BigDecimal.ROUND_HALF_EVEN)
					.toBigInteger();
		}
		return p;
	}
