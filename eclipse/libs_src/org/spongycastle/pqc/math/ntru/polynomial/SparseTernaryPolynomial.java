...
public class SparseTernaryPolynomial implements TernaryPolynomial {
	 ...
	 * @throws IOException
	 */
	public static SparseTernaryPolynomial fromBinary(InputStream is, int N,
			int numOnes, int numNegOnes) throws IOException {
	 ...
	 *            number of -1's
	 */
	public static SparseTernaryPolynomial generateRandom(int N, int numOnes,
