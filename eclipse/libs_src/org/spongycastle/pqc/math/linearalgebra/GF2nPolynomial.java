...
public class GF2nPolynomial {
	...
	/**
	 * Creates a new PolynomialGF2n by cloning the given PolynomialGF2n
	 * <i>a</i>.
	 * 
	 * @param a
	...
	/**
	 * Multiplies the scalar <i>s</i> to each coefficient of this PolynomialGF2n
	 * and returns the result in a new PolynomialGF2n.
	 * 
	 * @param s
	 ...
	 * @throws DifferentFieldsException
	 *             if <tt>this</tt>, <tt>b</tt> and <tt>g</tt> are not all
	 *             defined over the same field.
	 */
	public final GF2nPolynomial multiplyAndReduce(GF2nPolynomial b,
			GF2nPolynomial g) throws RuntimeException, ArithmeticException {
	 ...
	 */
	public final GF2nPolynomial gcd(GF2nPolynomial g) throws RuntimeException,
			ArithmeticException {
		GF2nPolynomial a = new GF2nPolynomial(this);
