...
public class GF2nPolynomialField extends GF2nField {
	 ...
	 * @param file
	 *            true if you want to read the field polynomial from the file
	 *            false if you want to use a random fielpolynomial (this can
	 ...
	 * and stores the result in <i>field polynomial</i>. This can take very long
	 * for huge degrees.
	 * 
	 * @return true
	 */
