...
public class IndexGenerator {
	 ...
	 * 
	 * @param seed
	 *            a seed of arbitrary length to initialize the index generator
	 *            with
	 * @param params
	...
	public static class BitString {
		...
		int numBytes; // includes the last byte even if only some of its bits
						// are used
		...
		/**
		 * Returns the last <code>numBits</code> bits from the end of the bit
		 * string.
		 * 
		 * @param numBits
		 *            number of bits
		 ...
		 * @param numBits
		 *            number of bits
		 * @return an <code>int</code> whose lower <code>numBits</code> bits are
		 *         the beginning of the bit string
		 */
