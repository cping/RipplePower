 ...
 */
public class NTRUEncryptionPublicKeyParameters extends
	...
	/**
	 * Reads a polynomial <code>h</code> from an input stream and constructs a
	 * new public key
	 * 
	 * @param is
	 *            an input stream
	 ...
	 */
	public NTRUEncryptionPublicKeyParameters(InputStream is,
