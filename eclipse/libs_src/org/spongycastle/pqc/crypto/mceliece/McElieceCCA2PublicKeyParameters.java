...
public class McElieceCCA2PublicKeyParameters extends McElieceCCA2KeyParameters {
	 ...
	 */
	public McElieceCCA2PublicKeyParameters(String oid, int n, int t,
			GF2Matrix matrix, McElieceCCA2Parameters params) {
		super(false, params);
		this.oid = oid;
		this.n = n;
		this.t = t;
	 ...
	 */
	public McElieceCCA2PublicKeyParameters(String oid, int n, int t,
			byte[] encMatrix, McElieceCCA2Parameters params) {
		super(false, params);
		this.oid = oid;
		this.n = n;
		this.t = t;
