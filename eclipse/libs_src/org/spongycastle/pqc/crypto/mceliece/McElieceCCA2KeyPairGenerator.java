 ...
 */
public class McElieceCCA2KeyPairGenerator implements
	...
	private void initializeDefault() {
		McElieceCCA2KeyGenerationParameters mcCCA2Params = new McElieceCCA2KeyGenerationParameters(
				new SecureRandom(), new McElieceCCA2Parameters());
		init(mcCCA2Params);
	}
	...
	public AsymmetricCipherKeyPair generateKeyPair() {
		...
		// generate keys
		McElieceCCA2PublicKeyParameters pubKey = new McElieceCCA2PublicKeyParameters(
				OID, n, t, shortG, mcElieceCCA2Params.getParameters());
		McElieceCCA2PrivateKeyParameters privKey = new McElieceCCA2PrivateKeyParameters(
				OID, n, k, field, gp, p, h, qInv,
