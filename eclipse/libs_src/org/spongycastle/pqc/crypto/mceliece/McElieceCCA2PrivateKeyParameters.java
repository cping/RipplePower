...
public class McElieceCCA2PrivateKeyParameters extends McElieceCCA2KeyParameters {
	 ...
	 */
	public McElieceCCA2PrivateKeyParameters(String oid, int n, int k,
			GF2mField field, PolynomialGF2mSmallM gp, Permutation p,
	 ...
	 */
	public McElieceCCA2PrivateKeyParameters(String oid, int n, int k,
			byte[] encFieldPoly, byte[] encGoppaPoly, byte[] encP, byte[] encH,
