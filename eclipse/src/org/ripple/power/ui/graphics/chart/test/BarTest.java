...
public class BarTest {
	public static void main(String[] args) {
		...
		frame.setSize(size);
	      ...
	      ChartValueSerie gg = new ChartValueSerie(LColor.GREEN.getRGB(),2);
	      ...
	      ChartValueSerie bb = new ChartValueSerie(LColor.BLUE.getRGB(),3);
	     ...
	     BarChartCanvas canvas  = new BarChartCanvas(400, 400);
