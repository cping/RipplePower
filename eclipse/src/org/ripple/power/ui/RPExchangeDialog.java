...
public class RPExchangeDialog extends JDialog{
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CNY/XRP", "Item 2", "Item 3", "Item 4" }));
        getContentPane().add(jComboBox1);
        jComboBox1.setBounds(640, 10, 110, 30);
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "RippleChina" }));
        getContentPane().add(jComboBox2);
        jComboBox2.setBounds(90, 10, 450, 30);
