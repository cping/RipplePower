...
public class TransactionPanel extends JPanel implements ActionListener {
    ...
    private static final int[] columnTypes = {
        AddressTable.DATE, AddressTable.ADDRESS, AddressTable.TYPE, AddressTable.ADDRESS, AddressTable.AMOUNT,
        AddressTable.AMOUNT, AddressTable.STATUS, AddressTable.STATUS};
    ...
    public TransactionPanel(JFrame parentFrame) {
        ...
        String frameSize = BTCLoader.properties.getProperty("window.main.size");
        if (frameSize != null) {
            ...
            switch (column) {
                ...
                case 7:                                 // Status
                    try {
                        ...
                        ErrorLog.logException("Unable to get transaction depth", exc);
                        value = "Unknown";
                    }
                    break;
                default:
