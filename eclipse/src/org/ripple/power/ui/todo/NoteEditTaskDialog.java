...
public class NoteEditTaskDialog extends javax.swing.JDialog {
	...
	private RPTodoUI parent;

	private TodoItem currentItem;

	public NoteEditTaskDialog(RPTodoUI parent, String title, TodoItem item) {
	...
	private void initComponents() {
		...
		panelEditor.setBorder(new javax.swing.border.LineBorder(
		...
		cboxType.setModel(new javax.swing.DefaultComboBoxModel(new String[] {
				"node", "root" }));
		...
		javax.swing.GroupLayout panelEditorLayout = new javax.swing.GroupLayout(
				panelEditor);
		panelEditor.setLayout(panelEditorLayout);
		panelEditorLayout
				.setHorizontalGroup(panelEditorLayout
						.createParallelGroup(
						...
						.addGroup(
								...
								panelEditorLayout
										...
										.addGap(27, 27, 27)));
		panelEditorLayout
				.setVerticalGroup(panelEditorLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelEditorLayout
		...
		btnSubmit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (s) {
					NoteEditTaskDialog.this.parent.refreshModel(ds
							.getAllItems());
					...
					NoteEditTaskDialog.this.setVisible(false);
				} else {
					JOptionPane.showMessageDialog(null, "Something is wrong",
							ds.getMessage(), JOptionPane.ERROR_MESSAGE);
				}
			}
		...
		javax.swing.GroupLayout panelControllerLayout = new javax.swing.GroupLayout(
				panelController);
		panelController.setLayout(panelControllerLayout);
		panelControllerLayout.setHorizontalGroup(panelControllerLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						javax.swing.GroupLayout.Alignment.TRAILING,
						panelControllerLayout.createSequentialGroup()
								.addContainerGap(221, Short.MAX_VALUE)
								.addComponent(btnSubmit).addGap(18, 18, 18)
								.addComponent(btnCancel).addContainerGap()));
		panelControllerLayout
				.setVerticalGroup(panelControllerLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								panelControllerLayout
