...
public class Realm {
	...
	private Realm(AuthScheme scheme, String principal, String password,
			String realmName, String nonce, String algorithm, String response,
			String qop, String nc, String cnonce, String uri, String method,
			boolean usePreemptiveAuth, String domain, String enc, String host,
	...
	public static class RealmBuilder {
		...
		private void newCnonce() {
			try {
				...
				byte[] b = md.digest(String.valueOf(System.currentTimeMillis())
						.getBytes("ISO-8859-1"));
		...
		private void newResponse() throws UnsupportedEncodingException {
			...
			if (qop == null || qop.length() == 0) {
				md.update(new StringBuilder(toBase16(ha1)).append(':')
						.append(nonce).append(':').append(toBase16(ha2))
						.toString().getBytes("ISO-8859-1"));
