...
public interface Body extends Closeable {
	 ...
	 * 
	 * @param buffer
	 *            The buffer to store the chunk in, must not be {@code null}.
	 * @return The non-negative number of bytes actually read or {@code -1} if
	 *         the body has been read completely.
	 * @throws IOException
