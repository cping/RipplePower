...
public abstract class Part implements org.asynchttpclient.Part {
	...
	/**
	 * The default boundary to be used if etBoundaryBytes(byte[]) has not been
	 * called.
	 */
	private static final byte[] DEFAULT_BOUNDARY_BYTES = MultipartEncodingUtil
	 ...
	 */
	static final byte[] QUOTE_BYTES = MultipartEncodingUtil
			.getAsciiBytes(QUOTE);
	 ...
	 */
	static final byte[] EXTRA_BYTES = MultipartEncodingUtil
			.getAsciiBytes(EXTRA);
	 ...
	 * Content dispostion as a byte array
	 */
	static final byte[] CONTENT_DISPOSITION_BYTES = MultipartEncodingUtil
	 ...
	 */
	static final byte[] CONTENT_TYPE_BYTES = MultipartEncodingUtil
	 ...
	 */
	static final byte[] CHARSET_BYTES = MultipartEncodingUtil
	 ...
	 * Content type header as a byte array
	 */
	static final byte[] CONTENT_TRANSFER_ENCODING_BYTES = MultipartEncodingUtil
	 ...
	 * Content type header as a byte array
	 */
	static final byte[] CONTENT_ID_BYTES = MultipartEncodingUtil
			.getAsciiBytes(CONTENT_ID);
	 ...
	 * {@link Part#sendParts(java.io.OutputStream, Part[], byte[])} and
	 ...
	 * 
	 * @return <code>true</code> if {@link #sendData(java.io.OutputStream)} can
	 *         be successfully called more than once.
	 * @since 3.0
	 */
