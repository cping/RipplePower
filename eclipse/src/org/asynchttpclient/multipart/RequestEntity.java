...
public interface RequestEntity {
	...
	/**
	 * Tests if {@link #writeRequest(java.io.OutputStream)} can be called more
	 * than once.
	 * 
	 * @return <tt>true</tt> if the entity can be written to
	 *         {@link java.io.OutputStream} more than once, <tt>false</tt>
	 *         otherwise.
	 */
	 ...
	 * it is not. In the latter case the EntityEnclosingMethod will use chunk
	 * encoding to transmit the request entity.
	 * 
