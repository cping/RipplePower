...
public interface RandomAccessBody extends Body {
	...
	/**
	 * Transfers the specified chunk of bytes from this body to the specified
	 * channel.
	 * 
	 * @param position
	 *            The zero-based byte index from which to start the transfer,
	 *            must not be negative.
	 * @param count
	 *            The maximum number of bytes to transfer, must not be negative.
	 * @param target
	 *            The destination channel to transfer the body chunk to, must
	 *            not be {@code null}.
