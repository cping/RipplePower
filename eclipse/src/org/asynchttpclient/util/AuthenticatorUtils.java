...
public final class AuthenticatorUtils {
	...
	public static String computeDigestAuthentication(Realm realm)
		...
		builder.append("algorithm").append('=').append(realm.getAlgorithm())
				.append(", ");
	...
	private static StringBuilder construct(StringBuilder builder, String name,
			String value) {
		return construct(builder, name, value, false);
	}

	private static StringBuilder construct(StringBuilder builder, String name,
			String value, boolean tail) {
		return builder.append(name).append('=').append('"').append(value)
				.append(tail ? "\"" : "\", ");
	}
}
