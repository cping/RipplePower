...
public class SslUtils {
	...
	public static SSLEngine getSSLEngine() throws GeneralSecurityException,
			IOException {
	...
	static SSLContext getStrictSSLContext(SSLConfig config)
		...
		try {
			keyStore.load(keystoreInputStream,
					(config.keyStorePassword == null) ? null
		...
		TrustManagerFactory trustManagerFactory = TrustManagerFactory
				.getInstance(config.trustManagerAlgorithm);
	...
	static SSLContext getLooseSSLContext() throws GeneralSecurityException {
		...
		sslContext.init(null,
				new TrustManager[] { LooseTrustManager.INSTANCE },
				new SecureRandom());
		return sslContext;
	}
	...
	private final static class SSLConfig {
		...
		public SSLConfig() {
			...
			keyManagerPassword = System.getProperty(
					"javax.net.ssl.keyStorePassword", "changeit");
			...
			if (trustStoreLocation == null) {
				...
				trustStoreType = System.getProperty(
						"javax.net.ssl.trustStoreType",
						KeyStore.getDefaultType());
			}
			trustManagerAlgorithm = Security
