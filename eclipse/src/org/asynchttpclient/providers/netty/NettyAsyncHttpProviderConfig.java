 ...
 */
public class NettyAsyncHttpProviderConfig implements
		AsyncHttpProviderConfig<String, Object> {

	private final static Logger LOGGER = LoggerFactory
			.getLogger(NettyAsyncHttpProviderConfig.class);
	 ...
	 */
	public final static String REUSE_ADDRESS = ChannelOption.SO_REUSEADDR
			.name();
	...
	public NettyAsyncHttpProviderConfig addProperty(String name, Object value) {
		...
		if (name.equals(REUSE_ADDRESS) && value == Boolean.TRUE
	...
	public void setHttpAdditionalChannelInitializer(
	...
	public void setWsAdditionalChannelInitializer(
	...
	public void setHttpsAdditionalChannelInitializer(
			AdditionalChannelInitializer httpsAdditionalChannelInitializer) {
	...
	public void setWssAdditionalChannelInitializer(
			AdditionalChannelInitializer wssAdditionalChannelInitializer) {
	...
	public static class EagerResponseBodyPartFactory implements
	...
	public static class LazyResponseBodyPartFactory implements
			ResponseBodyPartFactory {
