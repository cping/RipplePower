...
/**
 * An extended {@link AsyncHandler} with two extra callback who get invoked
 * during the content upload to a remote server. This {@link AsyncHandler} must
 * be used only with PUT and POST request.
 */
public interface ProgressAsyncHandler<T> extends AsyncHandler<T> {
	 ...
	 * 
	 * @return a {@link AsyncHandler.STATE} telling to CONTINUE or ABORT the
	 *         current processing.
	 */
	 ...
	 * wasn't fully written in a single I/O write operation. This method is
	 * never invoked if the write operation complete in a sinfle I/O write.
	 * 
	 * @param amount
