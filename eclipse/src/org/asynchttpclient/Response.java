...
public interface Response {
	...
	/**
	 * Returns an input stream for the response body. Note that you should not
	 * try to get this more than once, and that you should not close the stream.
	 * 
	...
	/**
	 * Returns the first maxLength bytes of the response body as a string. Note
	 * that this does not check whether the content type is actually a textual
	...
	/**
	 * Return the request {@link URI}. Note that if the request got redirected,
	 * the value of the {@link URI} will be the last valid redirect url.
	 * 
	...
	/**
	 * Subclasses SHOULD implement toString() in a way that identifies the
	 * request for logging.
	 * 
	 ...
	 * {@link AsyncHandler} It will return false if the either
	 * {@link AsyncHandler#onStatusReceived(HttpResponseStatus)} or
	 * {@link AsyncHandler#onHeadersReceived(HttpResponseHeaders)} returned
	...
	public static class ResponseBuilder {
		...
		public Response build() {
			return status == null ? null : status.prepareResponse(headers,
					bodyParts);
		}
