...
public interface ListenableFuture<V> extends Future<V> {
	...
	/**
	 * Terminate and if there is no exception, mark this Future as done and
	...
	/**
	 * Abort the current processing, and propagate the {@link Throwable} to the
	 * {@link AsyncHandler} or {@link Future}
	 * 
	 * @param t
	 */
	 ...
	 * be {@linkplain java.util.concurrent.Executor#execute(Runnable) passed to
	 * the executor} for execution when the {@code Future}'s computation is
