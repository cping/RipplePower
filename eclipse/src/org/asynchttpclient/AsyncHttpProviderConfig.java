...
/**
 * {@link AsyncHttpProvider} proprietary configurable properties. Note that
 * properties are <strong>AsyncHttpProvider</strong> dependent, so make sure you
 * consult the AsyncHttpProvider's documentation about what is supported and
 * what's not.
 */
