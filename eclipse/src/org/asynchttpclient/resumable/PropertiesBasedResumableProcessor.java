...
/**
 * A
 * {@link org.asynchttpclient.resumable.ResumableAsyncHandler.ResumableProcessor}
...
public class PropertiesBasedResumableProcessor implements
	...
	private final static Logger log = LoggerFactory
			.getLogger(PropertiesBasedResumableProcessor.class);
	...
	private static String append(Map.Entry<String, Long> e) {
		return new StringBuilder(e.getKey()).append("=").append(e.getValue())
				.append("\n").toString();
	}
	...
	public Map<String, Long> load() {
		...
		try {
			...
			log.debug("Loading previous download state {}",
					properties.toString());
