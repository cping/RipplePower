 ...
 * operation at the point it was before the interruption occurred. This prevent
 * having to download the entire file again. It's the responsibility of the
 * {@link org.asynchttpclient.resumable.ResumableAsyncHandler} to track how many
...
public class ResumableAsyncHandler implements AsyncHandler<Response> {
	...
	public AsyncHandler.STATE onHeadersReceived(HttpResponseHeaders headers)
		...
		String contentLengthHeader = headers.getHeaders().getFirstValue(
				"Content-Length");
	...
	public ResumableAsyncHandler setResumableListener(
			ResumableListener resumableListener) {
