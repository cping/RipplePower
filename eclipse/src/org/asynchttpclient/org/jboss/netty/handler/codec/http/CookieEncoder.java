 ...
 * <p>
 * This encoder is stateful. It maintains an internal data structure that holds
 * the {@link Cookie}s added by the {@link #addCookie(String, String)} method.
 * Once {@link #encode()} is called, all added {@link Cookie}s are encoded into
 * an HTTP header value and all {@link Cookie}s in the internal data structure
 * are removed so that the encoder can start over.
 * 
 * <pre>
 * // Client-side example
 ...
 */
// This fork brings support for RFC6265, that's used if the Cookie has a raw
// value
