...
public final class DataIO {
	...
	/*
	 * unpackInt,unpackLong, packInt, and packLong originally come from Kryo
	 * framework and were written by Nathan Sweet. It was modified to fit MapDB
	 * purposes. It is relicensed from BSD to Apache 2 with his permission:
	 * 
	 * Date: 27.5.2014 12:44
	 * 
	 * Hi Jan,
	 * 
	 * I'm fine with you putting code from the Kryo under Apache 2.0, as long as
	 * you keep the copyright and author. :)
	 * 
	 * Cheers! -Nate
	 * 
	 * -----------------------------
	 ...
	 * 
	 * This method originally comes from Kryo Framework, author Nathan Sweet. It
	 * was heavily modified to fit MapDB needs.
	 * 
	 * @param is
	 *            The input stream.
	...
	/**
	 * Pack long into output stream. It will occupy 1-10 bytes depending on
	 * value (lower values occupy smaller space)
	 * 
	 * This method originally comes from Kryo Framework, author Nathan Sweet. It
	 * was modified to fit MapDB needs.
	 * 
	 * @param out
	...
	/**
	 * Pack int into output stream. It will occupy 1-5 bytes depending on value
	 * (lower values occupy smaller space)
	 * 
	 * This method originally comes from Kryo Framework, author Nathan Sweet. It
	 * was modified to fit MapDB needs.
	 * 
	...
	/**
	 * Give access to internal byte[] or ByteBuffer in DataInput2.. Should not
	 * be used unless you are writing MapDB extension and needs some performance
	 * bonus
	 */
	...
	static public final class DataInputByteArray implements DataInput,
			DataInputInternal {
	 ...
	 * @author Jan Kotek
	 */
	public static final class DataInputByteBuffer implements DataInput,
			DataInputInternal {
		...
		public int readUnsignedShort() throws IOException {
			// $DELAY$
			return (((buf.get(pos++) & 0xff) << 8) | ((buf.get(pos++) & 0xff)));
		}
	...
	/**
	 * Provides {@link java.io.DataOutput} implementation on top of growable
	 * {@code byte[]}
	 * <p>
	 * {@link java.io.ByteArrayOutputStream} is not used as it requires
	 * {@code byte[]} copying
	 * 
	 * @author Jan Kotek
	 */
	public static final class DataOutputByteArray extends OutputStream
		...
		public DataOutputByteArray() {
			pos = 0;
			buf = new byte[16]; // TODO take hint from serializer for initial
								// size
