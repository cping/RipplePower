...
public class SerializerBase extends Serializer<Object> {
	...
	protected static abstract class Deser<A> {
		 ...
		 */
		abstract public Object deserialize(DataInput in,
	...
	protected final class DeserSingleton extends Deser {
		...
		@Override
		public Object deserialize(DataInput in, FastArrayList objectStack)
				throws IOException {
			return singleton;
		}
	}
	...
	protected void initSer() {
		...
		ser.put(boolean[].class, new SerHeaderSerializer(Header.ARRAY_BOOLEAN,
				Serializer.BOOLEAN_ARRAY));
		ser.put(short[].class, new SerHeaderSerializer(Header.ARRAY_SHORT,
				Serializer.SHORT_ARRAY));
		ser.put(char[].class, new SerHeaderSerializer(Header.ARRAY_CHAR,
				Serializer.CHAR_ARRAY));
		ser.put(float[].class, new SerHeaderSerializer(Header.ARRAY_FLOAT,
				Serializer.FLOAT_ARRAY));
		ser.put(double[].class, new SerHeaderSerializer(Header.ARRAY_DOUBLE,
				Serializer.DOUBLE_ARRAY));
		ser.put(int[].class, SER_INT_ARRAY);
		ser.put(long[].class, SER_LONG_ARRAY);

		ser.put(BigInteger.class, new SerHeaderSerializer(Header.BIGINTEGER,
				Serializer.BIG_INTEGER));
		ser.put(BigDecimal.class, new SerHeaderSerializer(Header.BIGDECIMAL,
				Serializer.BIG_DECIMAL));
		ser.put(Class.class, new SerHeaderSerializer(Header.CLASS,
				Serializer.CLASS));
		ser.put(Date.class, new SerHeaderSerializer(Header.DATE,
				Serializer.DATE));
		ser.put(UUID.class, new SerHeaderSerializer(Header.UUID,
				Serializer.UUID));
		...
		ser.put(Object[].class, new Ser<Object[]>() {
			...
			@Override
			public void serialize(DataOutput out, Object[] b,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(ArrayList.class, new Ser<ArrayList>() {
			@Override
			public void serialize(DataOutput out, ArrayList value,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(LinkedList.class, new Ser<Collection>() {
			@Override
			public void serialize(DataOutput out, Collection value,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(HashSet.class, new Ser<Collection>() {
			...
			public void serialize(DataOutput out, Collection value,
					FastArrayList objectStack) throws IOException {
				// TODO serialize hash salt to preserve order after
				// deserialization? applies to map as well
		...
		ser.put(LinkedHashSet.class, new Ser<Collection>() {
			...
			public void serialize(DataOutput out, Collection value,
					FastArrayList objectStack) throws IOException {
				serializeCollection(Header.LINKEDHASHSET, out, value,
						objectStack);
			}
		});
		...
		ser.put(HashMap.class, new Ser<Map>() {
			@Override
			public void serialize(DataOutput out, Map value,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(TreeSet.class, new Ser<TreeSet>() {
			@Override
			public void serialize(DataOutput out, TreeSet l,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(TreeMap.class, new Ser<TreeMap<Object, Object>>() {
			@Override
			public void serialize(DataOutput out, TreeMap<Object, Object> l,
					FastArrayList objectStack) throws IOException {
				...
				for (Map.Entry o : l.entrySet()) {
					...
					SerializerBase.this.serialize(out, o.getValue(),
							objectStack);
				}
			}
		});
		...
		ser.put(Fun.Pair.class, new Ser<Fun.Pair>() {
			@Override
			public void serialize(DataOutput out, Fun.Pair value,
					FastArrayList objectStack) throws IOException {
		...
		ser.put(BTreeKeySerializer.BasicKeySerializer.class,
				new Ser<BTreeKeySerializer.BasicKeySerializer>() {
					@Override
					public void serialize(DataOutput out,
							BTreeKeySerializer.BasicKeySerializer value,
							FastArrayList objectStack) throws IOException {
						out.write(Header.MAPDB);
						DataIO.packInt(out,
								HeaderMapDB.B_TREE_BASIC_KEY_SERIALIZER);
						SerializerBase.this.serialize(out, value.serializer,
								objectStack);
						SerializerBase.this.serialize(out, value.comparator,
								objectStack);
					}
				});
		...
		ser.put(Fun.ArrayComparator.class, new Ser<Fun.ArrayComparator>() {
			@Override
			public void serialize(DataOutput out, Fun.ArrayComparator value,
					FastArrayList objectStack) throws IOException {
				out.write(Header.MAPDB);
				DataIO.packInt(out, HeaderMapDB.COMPARATOR_ARRAY);
				SerializerBase.this.serialize(out, value.comparators,
						objectStack);
			}
		});
		...
		ser.put(CompressionWrapper.class, new Ser<CompressionWrapper>() {
			@Override
			public void serialize(DataOutput out, CompressionWrapper value,
					FastArrayList objectStack) throws IOException {
				out.write(Header.MAPDB);
		...
		ser.put(Array.class, new Ser<Array>() {
			@Override
			public void serialize(DataOutput out, Array value,
					FastArrayList objectStack) throws IOException {
				out.write(Header.MAPDB);
		...
		ser.put(BTreeKeySerializer.Compress.class,
				new Ser<BTreeKeySerializer.Compress>() {
					@Override
					public void serialize(DataOutput out,
							BTreeKeySerializer.Compress value,
							FastArrayList objectStack) throws IOException {
						out.write(Header.MAPDB);
						DataIO.packInt(out,
								HeaderMapDB.B_TREE_COMPRESS_KEY_SERIALIZER);
						SerializerBase.this.serialize(out, value.wrapped,
								objectStack);
					}
				});
	...
	public void serializeObjectArray(DataOutput out, Object[] b,
			FastArrayList objectStack) throws IOException {
	...
	protected void initHeaderDeser() {
		...
		headerDeser[Header.ZERO_FAIL] = new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				throw new IOError(
						new IOException("Zero Header, data corrupted"));
			}
		};
		...
		headerDeser[Header.INT_MIN_VALUE] = new DeserSingleton(
				Integer.MIN_VALUE);
		headerDeser[Header.INT_MAX_VALUE] = new DeserSingleton(
				Integer.MAX_VALUE);
		...
		headerDeser[Header.MA_VAR] = new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new Atomic.Var(getEngine(), SerializerBase.this, in,
						objectStack);
			}
		...
		headerDeser[Header.ARRAY_BOOLEAN] = new DeserSerializer(
				Serializer.BOOLEAN_ARRAY);
		headerDeser[Header.ARRAY_INT] = new DeserSerializer(
				Serializer.INT_ARRAY);
		headerDeser[Header.ARRAY_SHORT] = new DeserSerializer(
				Serializer.SHORT_ARRAY);
		headerDeser[Header.ARRAY_DOUBLE] = new DeserSerializer(
				Serializer.DOUBLE_ARRAY);
		headerDeser[Header.ARRAY_FLOAT] = new DeserSerializer(
				Serializer.FLOAT_ARRAY);
		headerDeser[Header.ARRAY_CHAR] = new DeserSerializer(
				Serializer.CHAR_ARRAY);
		headerDeser[Header.ARRAY_BYTE] = new DeserSerializer(
		...
		headerDeser[Header.ARRAY_LONG] = new DeserSerializer(
				Serializer.LONG_ARRAY);
		headerDeser[Header.BIGINTEGER] = new DeserSerializer(
				Serializer.BIG_INTEGER);
		headerDeser[Header.BIGDECIMAL] = new DeserSerializer(
				Serializer.BIG_DECIMAL);
		...
		headerDeser[Header.ARRAY_OBJECT_NO_REFS] = new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				// TODO serializatio code for this does not exist, add it in
				// future
				int size = DataIO.unpackInt(in);
				Class clazz = deserializeClass(in);
				Object[] s = (Object[]) java.lang.reflect.Array.newInstance(
						clazz, size);
	...
	public void serialize(final DataOutput out, final Object obj,
			FastArrayList<Object> objectStack) throws IOException {
	...
	protected static final Ser SER_STRING = new Ser<String>() {
		...
		public void serialize(DataOutput out, String value,
			...
			if (len == 0) {
				...
				for (int i = 0; i < len; i++)
					// TODO native UTF8 might be faster, investigate and perhaps
					// elimite packInt for chars!
	...
	protected static final Ser SER_LONG_ARRAY = new Ser<long[]>() {
		@Override
		public void serialize(DataOutput out, long[] val,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_INT_ARRAY = new Ser<int[]>() {
		@Override
		public void serialize(DataOutput out, int[] val,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_DOUBLE = new Ser<Double>() {
		@Override
		public void serialize(DataOutput out, Double value,
				FastArrayList objectStack) throws IOException {
			double v = value;
			if (v == -1D) {
	...
	protected static final Ser SER_FLOAT = new Ser<Float>() {
		@Override
		public void serialize(DataOutput out, Float value,
				FastArrayList objectStack) throws IOException {
			float v = value;
			if (v == -1f)
	...
	protected static final Ser SER_SHORT = new Ser<Short>() {
		@Override
		public void serialize(DataOutput out, Short value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_CHAR = new Ser<Character>() {
		@Override
		public void serialize(DataOutput out, Character value,
				FastArrayList objectStack) throws IOException {
			char val = value;
			if (val == 0) {
	...
	protected static final Ser SER_BYTE = new Ser<Byte>() {
		@Override
		public void serialize(DataOutput out, Byte value,
				FastArrayList objectStack) throws IOException {
			byte val = value;
			if (val == -1)
	...
	protected static final Ser SER_BOOLEAN = new Ser<Boolean>() {
		@Override
		public void serialize(DataOutput out, Boolean value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_INT = new Ser<Integer>() {
		@Override
		public void serialize(DataOutput out, Integer value,
				FastArrayList objectStack) throws IOException {
			int val = value;
			switch (val) {
			case -9:
	...
	protected static final Ser SER_MA_LONG = new Ser<Atomic.Long>() {
		@Override
		public void serialize(DataOutput out, Atomic.Long value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_MA_INT = new Ser<Atomic.Integer>() {
		@Override
		public void serialize(DataOutput out, Atomic.Integer value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_MA_BOOL = new Ser<Atomic.Boolean>() {
		@Override
		public void serialize(DataOutput out, Atomic.Boolean value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser SER_MA_STRING = new Ser<Atomic.String>() {
		@Override
		public void serialize(DataOutput out, Atomic.String value,
				FastArrayList objectStack) throws IOException {
	...
	protected final Ser SER_MA_VAR = new Ser<Atomic.Var>() {
		...
		@Override
		public void serialize(DataOutput out, Atomic.Var value,
				FastArrayList objectStack) throws IOException {
	...
	protected static final Ser<byte[]> SER_BYTE_ARRAY = new Ser<byte[]>() {
		@Override
		public void serialize(DataOutput out, byte[] b,
				FastArrayList objectStack) throws IOException {
	...
	public Object deserialize(DataInput in, FastArrayList<Object> objectStack)
			throws IOException {
		...
		if (head != Header.OBJECT_STACK && ret != null
				&& objectStack.size == oldObjectStackSize) {
	...
	protected void initMapdb() {
		...
		/*
		 * !!!! IMPORTANT !!!! Code bellow defines storage format, do not
		 * modify!!! !!!! IMPORTANT !!!!
		 */
		...
		mapdb_add(HeaderMapDB.SERIALIZER_KEY_TUPLE, new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new BTreeKeySerializer.ArrayKeySerializer(
						SerializerBase.this, in, objectStack);
			}
		...
		mapdb_add(HeaderMapDB.B_TREE_BASIC_KEY_SERIALIZER, new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new BTreeKeySerializer.BasicKeySerializer(
						SerializerBase.this, in, objectStack);
			}
		});
		...
		mapdb_add(HeaderMapDB.COMPARATOR_ARRAY, new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new Fun.ArrayComparator(SerializerBase.this, in,
						objectStack);
			}
		...
		mapdb_add(HeaderMapDB.SERIALIZER_COMPRESSION_WRAPPER, new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new CompressionWrapper(SerializerBase.this, in,
						objectStack);
			}
		...
		mapdb_add(HeaderMapDB.B_TREE_COMPRESS_KEY_SERIALIZER, new Deser() {
			...
			public Object deserialize(DataInput in, FastArrayList objectStack)
					throws IOException {
				return new BTreeKeySerializer.Compress(SerializerBase.this, in,
						objectStack);
			}
		});
		// 65
	...
	protected Object deserializeMapDB(DataInput is,
		...
		if (singleton == null) {
			throw new IOError(new IOException(
					"Unknown header byte, data corrupted"));
		}
	...
	private Object[] deserializeArrayObject(DataInput is,
		...
		Object[] s = (Object[]) java.lang.reflect.Array
	...
	private LinkedHashMap<Object, Object> deserializeLinkedHashMap(
			DataInput is, FastArrayList<Object> objectStack) throws IOException {
		int size = DataIO.unpackInt(is);
	...
	protected void serializeUnknownObject(DataOutput out, Object obj,
			FastArrayList<Object> objectStack) throws IOException {
		throw new AssertionError("Could not serialize unknown object: "
				+ obj.getClass().getName());
	}

	/** override this method to extend SerializerBase functionality */
	protected Object deserializeUnknownHeader(DataInput is, int head,
			FastArrayList<Object> objectStack) throws IOException {
	...
	protected static byte[] booleanToByteArray(boolean[] bool) {
		...
		int mod8 = boolLen % 8;
		byte[] boolBytes = new byte[(boolLen / 8)
				+ ((boolLen % 8 == 0) ? 0 : 1)];
		...
		for (boolByteIndex = 0; boolByteIndex < length;) {
			byte b = (byte) (((bool[x++] ? 0x01 : 0x00) << 0)
					...
					| ((bool[x++] ? 0x01 : 0x00) << 4)
					| ((bool[x++] ? 0x01 : 0x00) << 5)
					| ((bool[x++] ? 0x01 : 0x00) << 6) | ((bool[x++] ? 0x01
					: 0x00) << 7));
		...
		if (!isFlushWith8) {// If length is not a multiple of 8 we must do the
			...
			// //////////////////////
			/*
			 * The code below was replaced with the switch statement above. It
			 * increases performance by only doing 1 check against mod8 (switch
			 * statement) and only doing 1 assignment operation for every
			 * possible value of mod8, rather than doing up to 8 assignment
			 * operations and an if check in between each one. The code is
			 * longer but faster.
			 * 
			 * byte b = (byte) 0x00; b |= ((bool[x++]? 0x01 : 0x00) << 0); if
			 * (mod8 > 1) { b |= ((bool[x++]? 0x01 : 0x00) << 1); if (mod8 > 2)
			 * { b |= ((bool[x++]? 0x01 : 0x00) << 2); if (mod8 > 3) { b |=
			 * ((bool[x++]? 0x01 : 0x00) << 3); if (mod8 > 4) { b |=
			 * ((bool[x++]? 0x01 : 0x00) << 4); if (mod8 > 5) { b |=
			 * ((bool[x++]? 0x01 : 0x00) << 5); if (mod8 > 6) { b |=
			 * ((bool[x++]? 0x01 : 0x00) << 6); if (mod8 > 7) { b |=
			 * ((bool[x++]? 0x01 : 0x00) << 7); } } } } } } }
			 */
			boolBytes[boolByteIndex++] = b;
		}
	 ...
	 * in, and decompresses and converts them into an array of booleans using
	 * the toBooleanArray(byte[]); method. The array of booleans are trimmed to
	...
	protected interface Header {
		...
		int ZERO_FAIL = 0; // zero is invalid value, so it fails with
		...
		/**
		 * Value used in Java Serialization header. For this header we throw an
		 * exception because data might be corrupted
		 */
