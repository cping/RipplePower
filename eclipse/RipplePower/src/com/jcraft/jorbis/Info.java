...
public class Info {
	...
	public String toString() {
		return "version:" + Integer.valueOf(version) + ", channels:" + Integer.valueOf(channels) + ", rate:" + Integer.valueOf(rate)
				+ ", bitrate:" + Integer.valueOf(bitrate_upper) + "," + Integer.valueOf(bitrate_nominal) + ","
