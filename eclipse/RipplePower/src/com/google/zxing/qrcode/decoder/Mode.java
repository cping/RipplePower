...
public enum Mode {
	...
	NUMERIC(new int[] { 10, 12, 14 }, 0x01), ALPHANUMERIC(new int[] { 9, 11, 13 },
			0x02), STRUCTURED_APPEND(new int[] { 0, 0, 0 }, 0x03), // Not
																	// supported
	BYTE(new int[] { 8, 16, 16 }, 0x04), ECI(new int[] { 0, 0, 0 }, 0x07), // character
																			// counts
																			// don't
																			// apply
	KANJI(new int[] { 8, 10, 12 }, 0x08), FNC1_FIRST_POSITION(new int[] { 0, 0, 0 },
			0x05), FNC1_SECOND_POSITION(new int[] { 0, 0, 0 }, 0x09),
