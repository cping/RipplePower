...
public final class Detector {
	...
	public DetectorResult detect() throws NotFoundException {
		...
		if (4 * dimensionTop >= 7 * dimensionRight || 4 * dimensionRight >= 7 * dimensionTop) {
			...
			correctedTopRight = correctTopRightRectangular(bottomLeft, bottomRight, topLeft, topRight, dimensionTop,
					dimensionRight);
			...
			bits = sampleGrid(image, topLeft, bottomLeft, bottomRight, correctedTopRight, dimensionCorrected,
					dimensionCorrected);
		}
