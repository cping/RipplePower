...
public final class LSystem {
	...
	public static long applicationSleep = MINUTE;
	...
	public static boolean isMinJavaVersion(int major, int minor) {
		...
		if (installed.length < 2 && installedVersion.length() == 1) {
			return false;
		}
	...
	public static String setPassword(String password) throws Exception {
		...
		buffer = ssl.encrypt(buffer, LSystem.getUserName() + LSystem.applicationName + LSystem.getUUID());
	...
	public static String getPassword(String password) throws Exception {
		...
		buffer = ssl.decrypt(buffer, LSystem.getUserName() + LSystem.applicationName + LSystem.getUUID());
