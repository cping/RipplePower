...
/**
 * <p>
 * The 'getdata' message is used to request one or more blocks and transactions.
 * Blocks are returned as 'block' messages and transactions are returned as 'tx'
 * messages. Any entries that are not found are returned as a 'notfound'
 * response.
 * </p>
 *
 * <p>
...
public class GetDataMessage {
	 ...
	 *            Message listener
	 * @throws EOFException
	 *             End-of-data while processing message data
