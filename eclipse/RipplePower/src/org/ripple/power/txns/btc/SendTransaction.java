...
public class SendTransaction extends BlockTransaction {
	...
	public SendTransaction(Sha256Hash normID, Sha256Hash txHash, long txTime, Sha256Hash blockHash, Address address,
			BigInteger value, BigInteger fee, byte[] txData) {
