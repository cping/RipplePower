...
/**
 * The Bitcoin network consists of peer nodes which establish communication
 * links between themselves. The nodes exchange blocks and transactions which
 * are used to create new blocks which are then added to the block chain.
 *
 * The Peer object contains the information needed to handle communications with
 * a remote peer.
 */
public class Peer {
	 ...
	 * @param channel
	 *            The socket channel for this peer
	 * @param key
	 *            The selection key for this peer
	 */
	 ...
	 *
	 * @param relay
	 *            TRUE if transactions should be relayed
	 */
	 ...
	 *
	 * @param relay
	 *            TRUE if blocks should be relayed
	 */
	 ...
	 *
	 * @param incomplete
	 *            TRUE if response was incomplete
	 */
