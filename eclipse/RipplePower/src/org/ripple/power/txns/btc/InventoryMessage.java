...
/**
 * <p>
 * The 'inv' message is sent by a remote peer to advertise blocks and
 * transactions that are available. This message can be unsolicited or in
 * response to a 'getblocks' request.
 * </p>
 *
 * <p>
 * We will add items that we don't have to the 'pendingRequests' queue. This
 * will cause the network handler to send 'getdata' requests to get the missing
 * items.
 * </p>
 *
 * <p>
...
public class InventoryMessage {
	...
	public static void processInventoryMessage(Message msg, SerializedBuffer inBuffer, MessageListener msgListener)
		...
		if (count < 0 || count > 1000)
			throw new VerificationException("More than 1000 entries in 'inv' message", RejectMessage.REJECT_INVALID);
		//
		// Build the item list
		//
