 ...
 * location of a peer in the Bitcoin Peer-to-Peer network.
 */
public class PeerAddress implements ByteSerializable {
	...
	public static final byte[] IPV6_PREFIX = new byte[] { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
	...
	/**
	 * Constructs a peer address from a string in the format "[address]:port"
	 * where address can be "nnn.nnn.nnn.nnn" for IPv4 or
	...
	public PeerAddress(String peerString) throws UnknownHostException {
		...
		if (peerString.charAt(0) != '[' || addrSep < 0 || portSep < addrSep || portSep == peerString.length() - 1)
	 ...
	 *
	 * @param timeSeen
	 *            Time peer was seen in seconds since the epoch
	 */
	 ...
	 *
	 * @param wasBroadcast
	 *            True if the address has been broadcast
	 */
	 ...
	 *
	 * @param timeConnected
	 *            Time the peer connected (seconds since the epoch)
	 */
	 ...
	 *
	 * @param isStatic
	 *            TRUE if this is a static address
	 */
	...
	public boolean equals(Object obj) {
		return (obj != null && (obj instanceof PeerAddress) && address.equals(((PeerAddress) obj).address)
				&& port == ((PeerAddress) obj).port);
	}
