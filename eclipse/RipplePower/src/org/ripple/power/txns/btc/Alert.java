...
/**
 * <p>
 * An alert is sent out by the development team to notify all peers in the
 * network about a problem. The alert is displayed in the user interface and
 * written to the log. It is also sent each time a node connects to another node
 * until the relay time is exceeded or the alert is canceled.
 * </p>
 *
 * <p>
 * Alert Payload
...
public class Alert {
	 ...
	 *            Alert signature
	 * @throws EOFException
	 *             End-of-data while processing payload
	 */
	 ...
	 *
	 * @param isCanceled
	 *            TRUE if the alert has been canceled
	 */
