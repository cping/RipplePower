...
/**
 * SignInput represents a transaction output that is being spent as part of a
 * new transaction. It contains the key needed to sign the transaction as well
 * as the transaction output hash and index.
 */
