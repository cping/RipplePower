...
/**
 * VerificationException is thrown when an error is detected while deserializing
 * or verifying a block or transaction
 */
public class VerificationException extends Exception {
	...
	/**
	 * Creates a new exception with a detail message, reason code and
	...
	/**
	 * Creates a new exception with a detail message, block/transaction hash and
	 * cause
	 *
	 * @param msg
	 *            Detail message
	...
	/**
	 * Creates a new exception with a detail message, reason code,
	 * block/transaction hash and cause
	 *
	 * @param message
	 *            Detail message
	 * @param reason
