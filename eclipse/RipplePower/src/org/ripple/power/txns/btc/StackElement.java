...
/**
 * A script stack element is a series of zero or more bytes. The stack consists
 * of stack elements that are added and removed as the script is interpreted.
 * The byte array is processed as a little-endian signed number for numeric
 * script operations.
 */
public class StackElement implements Comparable<StackElement> {
	 ...
	 * Numeric values are stored on the stack in MPI format with the bytes
	 * reversed.
	 *
	...
	/**
	 * Tests if this element represents a TRUE or FALSE result. Any non-zero
	 * value is TRUE while any zero (positive or negative) is FALSE. A
	 * zero-length stack element is FALSE.
	 *
