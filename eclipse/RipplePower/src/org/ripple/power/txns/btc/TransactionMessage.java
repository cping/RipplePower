...
/**
 * <p>
 * The 'tx' message contains a transaction which is not yet in a block. The
 * transaction will be held in the memory pool for a period of time to allow
 * other peers to request the transaction.
 * </p>
 *
 * <p>
 * Transaction Message
...
public class TransactionMessage {
	...
	public static void processTransactionMessage(Message msg, SerializedBuffer inBuffer, MessageListener msgListener)
		...
		//
		// Notify the message listener that a transaction is ready for
		// processing
		//
