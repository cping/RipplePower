...
public class Bip39 {
	  public static byte[] decode (String mnemonic, String passphrase) throws Exception
	    {
	        ...
	        {
	            throw new Exception ("can not decrypt mnemonic", e);
	        }
	        return data;
	    }

	    public static String encode (byte[] data, String passphrase) throws Exception
	    {
	        if ( data.length % 8 != 0 )
	        {
	            throw new Exception ("can nor encode - data length not divisible with 8");
	        }
	        try
	        {
	            SecretKey seedkey = new SecretKeySpec (("mnemonic" + passphrase).getBytes ("UTF-8"), "Blowfish");
	    ...
	    public static String getMnemonic (byte[] data) throws Exception
	    {
	        if ( data.length % 4 != 0 )
	        {
