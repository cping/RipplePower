...
public class MinuteFive extends RegularTimer implements Serializable {
	...
	private long calcStart(Calendar cal) {
		...
		} else if (5 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 9) {
			cal = getStartDate(cal, 5);
		} else if (10 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 14) {
			cal = getStartDate(cal, 10);
		} else if (15 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 19) {
			cal = getStartDate(cal, 15);
		} else if (20 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 24) {
			cal = getStartDate(cal, 20);
		} else if (25 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 29) {
			cal = getStartDate(cal, 25);
		} else if (30 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 34) {
			cal = getStartDate(cal, 30);
		} else if (35 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 39) {
			cal = getStartDate(cal, 35);
		} else if (40 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 44) {
			cal = getStartDate(cal, 40);
		} else if (45 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 49) {
			cal = getStartDate(cal, 45);
		} else if (50 <= cal.get(Calendar.MINUTE) && cal.get(Calendar.MINUTE) <= 54) {
