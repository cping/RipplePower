...
public class RippleSigner {
	...
	public boolean isSignatureVerified(RippleObject serObj) {
		try {
			...
			signer.init(false, new ECPublicKeyParameters(signature.publicSigningKey, RippleGenerator.SECP256K1_PARAMS));
	...
	public static class ECDSASignature {
		...
		public ECDSASignature(byte[] signatureDEREncodedBytes, byte[] signingPubKey) throws IOException {
			publicSigningKey = RippleGenerator.SECP256K1_PARAMS.getCurve().decodePoint(signingPubKey);
