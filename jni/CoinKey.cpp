...
bool CoinKey::setSecure(const string_secure& import)
{
    uchar_vector_secure privateKey;
    bool bCompressed;

    if (!fromBase58Check(import, privateKey, this->walletImportVersion)){
        return false;
	}
